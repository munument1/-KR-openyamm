...
TEST_CASE("indoor scene runtime state survives save round trip")
{
    ...
    actorState.suppressLowHealthFlee = true;
    actorState.spellEffects.dayOfProtectionRemainingSeconds = 11.0f;
    actorState.spellEffects.dayOfProtectionPower = 12;
    actorState.spellEffects.hourOfPowerRemainingSeconds = 13.0f;
    actorState.spellEffects.hourOfPowerPower = 14;
    actorState.spellEffects.painReflectionRemainingSeconds = 15.0f;
    actorState.spellEffects.hammerhandsRemainingSeconds = 16.0f;
    actorState.spellEffects.hammerhandsPower = 17;
    actorState.spellEffects.hasteRemainingSeconds = 18.0f;
    actorState.spellEffects.shieldRemainingSeconds = 19.0f;
    actorState.spellEffects.stoneskinRemainingSeconds = 20.0f;
    actorState.spellEffects.stoneskinPower = 21;
    actorState.spellEffects.blessRemainingSeconds = 22.0f;
    actorState.spellEffects.blessPower = 23;
    actorState.spellEffects.fateRemainingSeconds = 24.0f;
    actorState.spellEffects.fatePower = 25;
    actorState.spellEffects.heroismRemainingSeconds = 26.0f;
    actorState.spellEffects.heroismPower = 27;
    ...
    CHECK(loadedActorState.suppressLowHealthFlee);
    CHECK_EQ(loadedActorState.spellEffects.dayOfProtectionRemainingSeconds, 11.0f);
    CHECK_EQ(loadedActorState.spellEffects.dayOfProtectionPower, 12);
    CHECK_EQ(loadedActorState.spellEffects.hourOfPowerRemainingSeconds, 13.0f);
    CHECK_EQ(loadedActorState.spellEffects.hourOfPowerPower, 14);
    CHECK_EQ(loadedActorState.spellEffects.painReflectionRemainingSeconds, 15.0f);
    CHECK_EQ(loadedActorState.spellEffects.hammerhandsRemainingSeconds, 16.0f);
    CHECK_EQ(loadedActorState.spellEffects.hammerhandsPower, 17);
    CHECK_EQ(loadedActorState.spellEffects.hasteRemainingSeconds, 18.0f);
    CHECK_EQ(loadedActorState.spellEffects.shieldRemainingSeconds, 19.0f);
    CHECK_EQ(loadedActorState.spellEffects.stoneskinRemainingSeconds, 20.0f);
    CHECK_EQ(loadedActorState.spellEffects.stoneskinPower, 21);
    CHECK_EQ(loadedActorState.spellEffects.blessRemainingSeconds, 22.0f);
    CHECK_EQ(loadedActorState.spellEffects.blessPower, 23);
    CHECK_EQ(loadedActorState.spellEffects.fateRemainingSeconds, 24.0f);
    CHECK_EQ(loadedActorState.spellEffects.fatePower, 25);
    CHECK_EQ(loadedActorState.spellEffects.heroismRemainingSeconds, 26.0f);
    CHECK_EQ(loadedActorState.spellEffects.heroismPower, 27);
