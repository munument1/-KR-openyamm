...
SetMapMetadata({
    ...
    contextActions = {
    [11] = { kind = "enter_house", source = "opcode", houseId = 508, targetName = "Wilburt's Hovel" },
    [13] = { kind = "enter_house", source = "opcode", houseId = 762, targetName = "Jack's Hovel" },
    [15] = { kind = "enter_house", source = "opcode", houseId = 777, targetName = "Iver's Estate" },
    [17] = { kind = "enter_house", source = "opcode", houseId = 785, targetName = "Pederton Place" },
    [19] = { kind = "enter_house", source = "opcode", houseId = 793, targetName = "Puddle's Hovel" },
    [21] = { kind = "enter_house", source = "opcode", houseId = 796, targetName = "Forgewright Estate" },
    [23] = { kind = "enter_house", source = "opcode", houseId = 799, targetName = "Apple Home" },
    [25] = { kind = "enter_house", source = "opcode", houseId = 805, targetName = "Treblid's Home" },
    [27] = { kind = "enter_house", source = "opcode", houseId = 814, targetName = "Holden's Hovel" },
    [29] = { kind = "enter_house", source = "opcode", houseId = 824, targetName = "Aznog's Hovel" },
    [31] = { kind = "enter_house", source = "opcode", houseId = 834, targetName = "Luodrin House" },
    [33] = { kind = "enter_house", source = "opcode", houseId = 844, targetName = "Applebee Estate" },
    [35] = { kind = "enter_house", source = "opcode", houseId = 853, targetName = "Archibald's Home" },
    [37] = { kind = "enter_house", source = "opcode", houseId = 861, targetName = "Arius' House" },
    [39] = { kind = "enter_house", source = "opcode", houseId = 867, targetName = "Deerhunter's House" },
    [41] = { kind = "enter_house", source = "opcode", houseId = 871, targetName = "Townsaver Hall" },
    [43] = { kind = "enter_house", source = "opcode", houseId = 874, targetName = "Jobber's Home" },
    [45] = { kind = "enter_house", source = "opcode", houseId = 877, targetName = "Maylander's House" },
    [47] = { kind = "enter_house", source = "opcode", houseId = 880, targetName = "Bluesawn Home" },
    [49] = { kind = "enter_house", source = "opcode", houseId = 883, targetName = "Quicktongue Estate" },
    [51] = { kind = "enter_house", source = "opcode", houseId = 886, targetName = "Laraselle Estate" },
    [53] = { kind = "enter_house", source = "opcode", houseId = 888, targetName = "Hillsman Cottage" },
    [55] = { kind = "enter_house", source = "opcode", houseId = 889, targetName = "Caverhill Estate" },
    [57] = { kind = "enter_house", source = "opcode", houseId = 890, targetName = "Reaver's Home" },
    [59] = { kind = "enter_house", source = "opcode", houseId = 891, targetName = "Temper Hall" },
    [61] = { kind = "enter_house", source = "opcode", houseId = 892, targetName = "Putnam's Home" },
    [63] = { kind = "enter_house", source = "opcode", houseId = 893, targetName = "Karrand's Cottage" },
    [65] = { kind = "enter_house", source = "opcode", houseId = 894, targetName = "Lathius' Home" },
    [67] = { kind = "enter_house", source = "opcode", houseId = 895, targetName = "Guild of Bounty Hunters" },
    [69] = { kind = "enter_house", source = "opcode", houseId = 896, targetName = "Botham Hall" },
    [71] = { kind = "enter_house", source = "opcode", houseId = 897, targetName = "Neblick's House" },
    [73] = { kind = "enter_house", source = "opcode", houseId = 898, targetName = "Stonecleaver Hall" },
    [75] = { kind = "enter_house", source = "opcode", houseId = 899, targetName = "Hostel" },
    [77] = { kind = "enter_house", source = "opcode", houseId = 900, targetName = "Hostel" },
    [79] = { kind = "enter_house", source = "opcode", houseId = 901, targetName = "Brigham's Home" },
    ...
    [171] = { kind = "enter_house", source = "opcode", houseId = 2, targetName = "Keen Edge" },
    [173] = { kind = "enter_house", source = "opcode", houseId = 37, targetName = "The Polished Shield" },
    [175] = { kind = "enter_house", source = "opcode", houseId = 77, targetName = "Needful Things" },
    [177] = { kind = "enter_house", source = "opcode", houseId = 111, targetName = "Apothecary" },
    [179] = { kind = "enter_house", source = "opcode", houseId = 184, targetName = "Vexation's Hexes" },
    [181] = { kind = "enter_house", source = "opcode", houseId = 452, targetName = "Guild Caravans" },
    [183] = { kind = "enter_house", source = "opcode", houseId = 480, targetName = "The Dauntless" },
    [185] = { kind = "enter_house", source = "opcode", houseId = 304, targetName = "Sanctum" },
    [187] = { kind = "enter_house", source = "opcode", houseId = 1565, targetName = "Gymnasium" },
    [191] = { kind = "enter_house", source = "opcode", houseId = 229, targetName = "Kessel's Kantina" },
    [193] = { kind = "enter_house", source = "opcode", houseId = 282, targetName = "Steele's Vault" },
    [195] = { kind = "enter_house", source = "opcode", houseId = 83, targetName = "Caori's Curios" },
    [197] = { kind = "enter_house", source = "opcode", houseId = 237, targetName = "The Dancing Ogre" },
    [199] = { kind = "enter_house", source = "opcode", houseId = 483, targetName = "Wind" },
    [201] = { kind = "enter_house", source = "opcode", houseId = 186, targetName = "Self Guild" },
    [203] = { kind = "enter_house", source = "opcode", houseId = 757, targetName = "Oracle" },
    [209] = { kind = "enter_house", source = "opcode", houseId = 1607, targetName = "The Adventurer's Inn" },
    [451] = { kind = "enter_house", source = "opcode", houseId = 902, targetName = "House Memoria" },
    [453] = { kind = "enter_house", source = "opcode", houseId = 903, targetName = "House of Hawthorne " },
    [455] = { kind = "enter_house", source = "opcode", houseId = 904, targetName = "Lott's Family Home" },
    [457] = { kind = "enter_house", source = "opcode", houseId = 905, targetName = "House of Nosewort" },
    [459] = { kind = "enter_house", source = "opcode", houseId = 909, targetName = "Dotes Family Hovel" },
    [461] = { kind = "enter_house", source = "opcode", houseId = 906, targetName = "Hall of the Tracker" },
    [463] = { kind = "enter_house", source = "opcode", houseId = 907, targetName = "Hunter's Hovel" },
    [465] = { kind = "enter_house", source = "opcode", houseId = 908, targetName = "Dervish's Cottage" },
    [467] = { kind = "enter_house", source = "opcode", houseId = 697, targetName = "House Understone" },
    [494] = { kind = "open_door", source = "title" },
    [501] = { kind = "enter_dungeon", source = "opcode", targetMap = "d07.blv", targetName = "Smuggler's Cove" },
    [502] = { kind = "enter_dungeon", source = "opcode", targetMap = "d08.blv", targetName = "Dire Wolf Den" },
    [503] = { kind = "enter_dungeon", source = "opcode", targetMap = "d09.blv", targetName = "Merchant House of Alvar" },
    [504] = { kind = "enter_dungeon", source = "opcode", targetMap = "d10.blv", targetName = "Escaton's Crystal" },
    [505] = { kind = "enter_dungeon", source = "opcode", targetMap = "d09.blv", targetName = "Merchant House of Alvar" },
    [506] = { kind = "enter_dungeon", source = "opcode", targetMap = "d28.blv", targetName = "Tomb of Lord Brinne" },
    [507] = { kind = "enter_dungeon", source = "opcode", targetMap = "d45.blv", targetName = "Chapel of Eep" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
