...
SetMapMetadata({
    ...
    [501] = { kind = "leave_dungeon", source = "opcode", targetMap = "elemf.odm", targetName = "Plane of Fire" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
...
RegisterEvent(501, "Leave the Castle of Fire", function()
    evt.MoveToMap(-13338, 16326, 3841, 1536, 0, 0, 0, 1, "elemf.odm") -- Plane of Fire
end, "Leave the Castle of Fire")
