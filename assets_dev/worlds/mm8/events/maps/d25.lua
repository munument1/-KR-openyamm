...
SetMapMetadata({
    ...
    [71] = { kind = "use_lever", source = "title" },
    ...
    [503] = { kind = "leave_dungeon", source = "opcode", targetMap = "out08.odm", targetName = "Ravage Roaming" },
    [504] = { kind = "leave_dungeon", source = "opcode", targetMap = "out08.odm", targetName = "Ravage Roaming" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
