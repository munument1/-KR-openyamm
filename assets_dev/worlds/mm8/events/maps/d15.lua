...
SetMapMetadata({
    ...
    [502] = { kind = "leave_dungeon", source = "opcode", targetMap = "out04.odm", targetName = "Ironsand Desert" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {6},
...
RegisterEvent(101, nil, function()
    evt.CastSpell(6, 10, 4, -8824, 5456, 48, 0, 0, 0) -- Fireball
    evt.CastSpell(6, 10, 4, -8680, 5456, 48, 0, 0, 0) -- Fireball
    evt.CastSpell(6, 10, 4, -8824, 5456, -88, 0, 0, 0) -- Fireball
    evt.CastSpell(6, 10, 4, -8680, 5456, -88, 0, 0, 0) -- Fireball
end)

RegisterEvent(501, "Leave the Chain of Fire", function()
    evt.MoveToMap(-3632, 18166, 0, 1024, 0, 0, 0, 1, "out04.odm") -- Ironsand Desert
end, "Leave the Chain of Fire")

RegisterEvent(502, "Leave the Chain of Fire", function()
    evt.MoveToMap(8236, 19211, 1, 0, 0, 0, 0, 1, "out04.odm") -- Ironsand Desert
end, "Leave the Chain of Fire")
