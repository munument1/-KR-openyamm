...
SetMapMetadata({
    ...
    [501] = { kind = "leave_dungeon", source = "opcode", targetMap = "elema.odm", targetName = "Plane of Air" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
...
RegisterEvent(501, "Leave the Castle Air", function()
    evt.MoveToMap(-11771, -9444, 3234, 2040, 0, 0, 0, 1, "elema.odm") -- Plane of Air
end, "Leave the Castle Air")
