...
SetMapMetadata({
    ...
    [109] = { kind = "secret_event", source = "heuristic", hidden = true },
    [110] = { kind = "secret_event", source = "heuristic", hidden = true },
    [201] = { kind = "enter_house", source = "opcode", houseId = 772, targetName = "Wererat Smuggler Leader" },
