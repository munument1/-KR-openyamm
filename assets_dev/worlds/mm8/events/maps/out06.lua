...
SetMapMetadata({
    ...
    contextActions = {
    [13] = { kind = "enter_house", source = "opcode", houseId = 577, targetName = "Taleshire Hall" },
    [15] = { kind = "enter_house", source = "opcode", houseId = 578, targetName = "Nightcrawler Estate" },
    [17] = { kind = "enter_house", source = "opcode", houseId = 579, targetName = "Mistspring Residence" },
    [19] = { kind = "enter_house", source = "opcode", houseId = 580, targetName = "House Arachnia" },
    [21] = { kind = "enter_house", source = "opcode", houseId = 581, targetName = "Dirthmoore Cottage" },
    [23] = { kind = "enter_house", source = "opcode", houseId = 582, targetName = "House of Lathaen" },
    [25] = { kind = "enter_house", source = "opcode", houseId = 583, targetName = "Brightsprear Hall" },
    [27] = { kind = "enter_house", source = "opcode", houseId = 584, targetName = "Nightwood Estate" },
    [29] = { kind = "enter_house", source = "opcode", houseId = 585, targetName = "House Shador" },
    [31] = { kind = "enter_house", source = "opcode", houseId = 586, targetName = "House Mercutura" },
    [33] = { kind = "enter_house", source = "opcode", houseId = 587, targetName = "Roggen Hall" },
    [35] = { kind = "enter_house", source = "opcode", houseId = 588, targetName = "Hallien's Cottage" },
    [37] = { kind = "enter_house", source = "opcode", houseId = 589, targetName = "Roberts Residence" },
    [39] = { kind = "enter_house", source = "opcode", houseId = 590, targetName = "Infaustus' House" },
    [41] = { kind = "enter_house", source = "opcode", houseId = 591, targetName = "House of Journey" },
    [43] = { kind = "enter_house", source = "opcode", houseId = 592, targetName = "Whisper Hall" },
    [45] = { kind = "enter_house", source = "opcode", houseId = 593, targetName = "Steeleye Estate" },
    [47] = { kind = "enter_house", source = "opcode", houseId = 594, targetName = "House of Benefice" },
    [49] = { kind = "enter_house", source = "opcode", houseId = 595, targetName = "House Umberpool" },
    [51] = { kind = "enter_house", source = "opcode", houseId = 596, targetName = "Kelvin's Home" },
    [53] = { kind = "enter_house", source = "opcode", houseId = 597, targetName = "Caverhill Hall" },
    [55] = { kind = "enter_house", source = "opcode", houseId = 598, targetName = "Veritas Estate" },
    [57] = { kind = "enter_house", source = "opcode", houseId = 599, targetName = "Stillwater Estate" },
    [59] = { kind = "enter_house", source = "opcode", houseId = 673, targetName = "Crane Cottage" },
    [61] = { kind = "enter_house", source = "opcode", houseId = 675, targetName = "Bith Estate" },
    [63] = { kind = "enter_house", source = "opcode", houseId = 602, targetName = "Fellburn Residence" },
    [65] = { kind = "enter_house", source = "opcode", houseId = 603, targetName = "Gallowswell Manor" },
    [67] = { kind = "enter_house", source = "opcode", houseId = 604, targetName = "House Fiddlebone" },
    [69] = { kind = "enter_house", source = "opcode", houseId = 605, targetName = "Deverbero Residence" },
    [71] = { kind = "enter_house", source = "opcode", houseId = 606, targetName = "Tantilion's House" },
    [73] = { kind = "enter_house", source = "opcode", houseId = 607, targetName = "Fist Residence" },
    [75] = { kind = "enter_house", source = "opcode", houseId = 608, targetName = "Wargreen's Lab" },
    [77] = { kind = "enter_house", source = "opcode", houseId = 609, targetName = "House Wallace" },
    ...
    [171] = { kind = "enter_house", source = "opcode", houseId = 5, targetName = "Blooded Daggers and Blades" },
    [173] = { kind = "enter_house", source = "opcode", houseId = 40, targetName = "Supple Leather" },
    [175] = { kind = "enter_house", source = "opcode", houseId = 80, targetName = "Mystical Mayhem" },
    [177] = { kind = "enter_house", source = "opcode", houseId = 113, targetName = "Wolves' Bane" },
    [181] = { kind = "enter_house", source = "opcode", houseId = 456, targetName = "Guild Caravans" },
    [183] = { kind = "enter_house", source = "opcode", houseId = 481, targetName = "Smoke" },
    [185] = { kind = "enter_house", source = "opcode", houseId = 307, targetName = "Cathedral of Night" },
    [187] = { kind = "enter_house", source = "opcode", houseId = 1568, targetName = "Assassin's School" },
    [191] = { kind = "enter_house", source = "opcode", houseId = 233, targetName = "Black Company" },
    [193] = { kind = "enter_house", source = "opcode", houseId = 284, targetName = "The Blood Bank" },
    [201] = { kind = "enter_house", source = "opcode", houseId = 175, targetName = "Guild of Dark" },
    [454] = { kind = "enter_house", source = "opcode", houseId = 113, targetName = "Wolves' Bane" },
    [501] = { kind = "enter_dungeon", source = "opcode", targetMap = "d19.blv", targetName = "Necromancers' Guild" },
    [502] = { kind = "enter_dungeon", source = "opcode", targetMap = "d20.blv", targetName = "Mad Necromancer's Lab " },
    [503] = { kind = "enter_dungeon", source = "opcode", targetMap = "d21.blv", targetName = "Vampire Crypt" },
    [504] = { kind = "enter_dungeon", source = "opcode", targetMap = "d49.blv", targetName = "Yaardrake's Cave" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
