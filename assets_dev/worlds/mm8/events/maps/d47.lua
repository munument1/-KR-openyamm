...
SetMapMetadata({
    ...
    [131] = { kind = "enter_house", source = "opcode", houseId = 704, targetName = "Duroth's Cave" },
...
RegisterEvent(131, "Duroth's Cave", function()
    evt.EnterHouse(704) -- Duroth's Cave
end, "Duroth's Cave")

RegisterEvent(501, "Leave Old Loeb's Cave", function()
    evt.MoveToMap(13168, 14920, 924, 1024, 0, 0, 0, 3, "out13.odm") -- Regna
end, "Leave Old Loeb's Cave")
