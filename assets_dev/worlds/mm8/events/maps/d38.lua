...
SetMapMetadata({
    ...
    [201] = { kind = "enter_house", source = "opcode", houseId = 662, targetName = "Water Lord's Cell" },
...
RegisterEvent(201, "Water Lord's Cell", function()
    evt.EnterHouse(662) -- Water Lord's Cell
end, "Water Lord's Cell")

RegisterEvent(501, "Leave Prison of the Lord of Water", function()
    evt.MoveToMap(-19900, -19531, 377, 512, 0, 0, 0, 1, "pbp.odm") -- Plane Between Planes
end, "Leave Prison of the Lord of Water")
