...
SetMapMetadata({
    ...
    [201] = { kind = "enter_house", source = "opcode", houseId = 663, targetName = "Earth Lord's Cell" },
...
RegisterEvent(201, "Earth Lord's Cell", function()
    evt.EnterHouse(663) -- Earth Lord's Cell
...
RegisterEvent(501, "Leave the Prison of the Lord of Earth", function()
    evt.MoveToMap(13858, -19595, 1, 512, 0, 0, 0, 1, "pbp.odm") -- Plane Between Planes
end, "Leave the Prison of the Lord of Earth")
