...
SetMapMetadata({
    ...
    [131] = { kind = "enter_house", source = "opcode", houseId = 702, targetName = "Flamdring's Cave" },
...
RegisterEvent(131, "Flamdring's Cave", function()
    evt.EnterHouse(702) -- Flamdring's Cave
end, "Flamdring's Cave")

RegisterEvent(501, "Leave Ilsingore's Cave", function()
    evt.MoveToMap(-17928, 14096, 2080, 1536, 0, 0, 0, 3, "out04.odm") -- Ironsand Desert
end, "Leave Ilsingore's Cave")
