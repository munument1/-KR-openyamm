...
SetMapMetadata({
    ...
    [171] = { kind = "enter_house", source = "opcode", houseId = 751, targetName = "Council Chamber Door" },
    [501] = { kind = "leave_dungeon", source = "opcode", targetMap = "out02.odm", targetName = "Ravenshore" },
    [502] = { kind = "leave_dungeon", source = "opcode", targetMap = "out02.odm", targetName = "Ravenshore" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
...
RegisterEvent(171, "Council Chamber Door", function()
    ...
    elseif IsQBitSet(QBit(37)) then -- Regnan Pirate Fleet is sunk.
        evt.SetNPCTopic(40, 1, 111) -- Elgar Fellmoon topic 1: Ironfists' Arrival
        evt.SetNPCTopic(52, 0, 118) -- Sir Charles Quixote topic 0: Xanthor
        evt.SetNPCTopic(53, 0, 125) -- Deftclaw Redreaver topic 0: Quixote's Treasure
        evt.SetNPCTopic(54, 0, 132) -- Oskar Tyre topic 0: Ironfists
        evt.SetNPCTopic(55, 0, 139) -- Masul topic 0: Catherine Ironfist
        evt.SetNPCTopic(56, 0, 146) -- Sandro topic 0: Wizards
        evt.EnterHouse(751) -- Council Chamber Door
        return
    ...
    elseif IsQBitSet(QBit(19)) then -- Allied with Necromancers Guild. Steal Nightshade Brazier done.
        if IsQBitSet(QBit(21)) then -- Allied with Charles Quioxte's Dragon Hunters. Return Dragon Egg to Quixote done.
            if IsQBitSet(QBit(23)) then -- Allied with Minotaurs. Rescue the Minotaurs done.
                ...
                evt.SetNPCTopic(40, 0, 106) -- Elgar Fellmoon topic 0: Ironfists
                evt.SetNPCTopic(40, 1, 108) -- Elgar Fellmoon topic 1: Pirates
                evt.SetNPCTopic(52, 0, 117) -- Sir Charles Quixote topic 0: Blackwell Cooper
                evt.SetNPCTopic(53, 0, 124) -- Deftclaw Redreaver topic 0: Regna Island
                evt.SetNPCTopic(54, 0, 131) -- Oskar Tyre topic 0: Mace of the Sun
                evt.SetNPCTopic(55, 0, 138) -- Masul topic 0: Pirate Raid
                evt.SetNPCTopic(56, 0, 145) -- Sandro topic 0: Pirate Mages
...
RegisterEvent(501, "Leave Merchant House of Alvar", function()
    evt.MoveToMap(12894, -12153, 257, 1536, 0, 0, 0, 1, "out02.odm") -- Ravenshore
end, "Leave Merchant House of Alvar")

RegisterEvent(502, "Leave Merchant House of Alvar", function()
    evt.MoveToMap(11284, -11009, 258, 1024, 0, 0, 0, 1, "out02.odm") -- Ravenshore
end, "Leave Merchant House of Alvar")
