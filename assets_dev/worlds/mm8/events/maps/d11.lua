...
SetMapMetadata({
    ...
    [502] = { kind = "leave_dungeon", source = "opcode", targetMap = "out03.odm", targetName = "Alvar" },
    [503] = { kind = "teleport", source = "heuristic" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
...
RegisterEvent(501, "Leave the Wasp Nest", function()
    evt.MoveToMap(14350, -6955, 0, 640, 0, 0, 0, 1, "out03.odm") -- Alvar
end, "Leave the Wasp Nest")

RegisterEvent(502, "Leave the Wasp Nest", function()
    evt.MoveToMap(16390, -4941, 433, 1280, 0, 0, 0, 1, "out03.odm") -- Alvar
end, "Leave the Wasp Nest")
