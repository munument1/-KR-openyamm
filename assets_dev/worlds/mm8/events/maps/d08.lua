...
RegisterEvent(6, nil, function()
    ...
    if not IsQBitSet(QBit(141)) then -- Dire Wolf Questbit for Riki
        ...
        evt.SummonMonsters(1, 1, 222, -2134, 1, 0, 1, 0) -- encounter slot 1 "Dire Wolf" tier A, count 222, pos=(-2134, 1, 0), actor group 1, no unique actor name
...
RegisterEvent(501, "Leave the Dire Wolf Den", function()
    evt.MoveToMap(-20372, 16365, 2, 0, 0, 0, 0, 1, "out02.odm") -- Ravenshore
