...
SetMapMetadata({
    ...
    contextActions = {
    [11] = { kind = "enter_house", source = "opcode", houseId = 610, targetName = "Ravensight Residence" },
    [13] = { kind = "enter_house", source = "opcode", houseId = 611, targetName = "Dreamwright Residence" },
    [15] = { kind = "enter_house", source = "opcode", houseId = 612, targetName = "Snowtree Residence" },
    [17] = { kind = "enter_house", source = "opcode", houseId = 613, targetName = "Dantillion's Residence" },
    [19] = { kind = "enter_house", source = "opcode", houseId = 614, targetName = "Mithrit Residence" },
    [21] = { kind = "enter_house", source = "opcode", houseId = 615, targetName = "Tonk Residence" },
    [23] = { kind = "enter_house", source = "opcode", houseId = 616, targetName = "Keenedge Residence" },
    [25] = { kind = "enter_house", source = "opcode", houseId = 617, targetName = "Treasurestone Residence" },
    [27] = { kind = "enter_house", source = "opcode", houseId = 618, targetName = "Sampson Residence" },
    [29] = { kind = "enter_house", source = "opcode", houseId = 701, targetName = "Verish's House" },
    ...
    [191] = { kind = "enter_house", source = "opcode", houseId = 234, targetName = "Traveler's Rest" },
    [201] = { kind = "enter_house", source = "opcode", houseId = 170, targetName = "Guild of Light" },
    [501] = { kind = "enter_dungeon", source = "opcode", targetMap = "d22.blv", targetName = "Temple of the Sun" },
    [502] = { kind = "enter_dungeon", source = "opcode", targetMap = "d23.blv", targetName = "Druid Circle" },
    [503] = { kind = "travel", source = "opcode", targetMap = "elema.odm", targetName = "Plane of Air" },
    [504] = { kind = "enter_dungeon", source = "opcode", targetMap = "d43.blv", targetName = "Ancient Troll Home" },
    },
    textureNames = {},
    spriteNames = {"0"},
    castSpellIds = {},
    timers = {
    { eventId = 451, sourceEventId = 451, triggerStep = 0, origin = "legacy", triggerKind = "timer", scheduleKind = "interval", intervalHalfMinutes = 30 },
    { eventId = 452, sourceEventId = 452, triggerStep = 0, origin = "legacy", triggerKind = "timer", scheduleKind = "interval", intervalHalfMinutes = 25 },
    },
})
