...
SetMapMetadata({
    ...
    [201] = { kind = "enter_house", source = "opcode", houseId = 664, targetName = "Fire Lord's Cell" },
...
RegisterEvent(201, "Fire Lord's Cell", function()
    evt.EnterHouse(664) -- Fire Lord's Cell
end, "Fire Lord's Cell")

RegisterEvent(501, "Leave the Prison of the Lord of Fire", function()
    evt.MoveToMap(-20044, 20946, 321, 0, 0, 0, 0, 1, "pbp.odm") -- Plane Between Planes
end, "Leave the Prison of the Lord of Fire")
