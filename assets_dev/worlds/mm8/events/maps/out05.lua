...
SetMapMetadata({
    ...
    contextActions = {
    [11] = { kind = "enter_house", source = "opcode", houseId = 538, targetName = "Stormlance Residence" },
    [13] = { kind = "enter_house", source = "opcode", houseId = 539, targetName = "Morningstar Residence" },
    [15] = { kind = "enter_house", source = "opcode", houseId = 540, targetName = "Foestryke Residence" },
    [17] = { kind = "enter_house", source = "opcode", houseId = 541, targetName = "Ironfist Residence" },
    [19] = { kind = "enter_house", source = "opcode", houseId = 562, targetName = "Avalon's Residence" },
    [21] = { kind = "enter_house", source = "opcode", houseId = 563, targetName = "Arin Residence" },
    [23] = { kind = "enter_house", source = "opcode", houseId = 564, targetName = "Lightsworn Residence" },
    [25] = { kind = "enter_house", source = "opcode", houseId = 565, targetName = "Otterton Residence" },
    [27] = { kind = "enter_house", source = "opcode", houseId = 566, targetName = "Calandril's Residence" },
    [29] = { kind = "enter_house", source = "opcode", houseId = 567, targetName = "Maker Residence" },
    [31] = { kind = "enter_house", source = "opcode", houseId = 568, targetName = "Slayer Residence" },
    [33] = { kind = "enter_house", source = "opcode", houseId = 569, targetName = "Kern Residence" },
    [35] = { kind = "enter_house", source = "opcode", houseId = 570, targetName = "Jeni Residence" },
    [37] = { kind = "enter_house", source = "opcode", houseId = 571, targetName = "Weldrick's Home" },
    [39] = { kind = "enter_house", source = "opcode", houseId = 699, targetName = "Nelix's House" },
    [41] = { kind = "enter_house", source = "opcode", houseId = 700, targetName = "Tempus' House" },
    [43] = { kind = "enter_house", source = "opcode", houseId = 542, targetName = "Reaverston Residence" },
    ...
    [171] = { kind = "enter_house", source = "opcode", houseId = 4, targetName = "Lance's Spears" },
    [173] = { kind = "enter_house", source = "opcode", houseId = 39, targetName = "Plated Protection" },
    [175] = { kind = "enter_house", source = "opcode", houseId = 79, targetName = "Wards and Pendants" },
    [181] = { kind = "enter_house", source = "opcode", houseId = 455, targetName = "Guild Caravans" },
    [185] = { kind = "enter_house", source = "opcode", houseId = 306, targetName = "Sacred Steel" },
    [187] = { kind = "enter_house", source = "opcode", houseId = 1567, targetName = "Godric's Gauntlet" },
    [191] = { kind = "enter_house", source = "opcode", houseId = 232, targetName = "Dragon's Blood Inn" },
    [501] = { kind = "enter_dungeon", source = "opcode", targetMap = "d16.blv", targetName = "Dragon Hunter's Camp" },
    [502] = { kind = "enter_dungeon", source = "opcode", targetMap = "d17.blv", targetName = "Dragon Cave" },
    [503] = { kind = "enter_dungeon", source = "opcode", targetMap = "d18.blv", targetName = "Naga Vault" },
    [504] = { kind = "enter_dungeon", source = "opcode", targetMap = "d44.blv", targetName = "Grand Temple of Eep" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
