...
RegisterEvent(10, nil, function()
    ...
    if HasItem(612) and HasItem(627) then -- Sarcophagus of Korbu
        SetQBit(QBit(81)) -- Found the Sarcophagus of Korbu
    else
    end
end)
...
RegisterEvent(101, nil, function()
    ...
    evt.CastSpell(15, 10, 4, -4072, -4232, 348, -1, -1, -1) -- Sparks
    evt.CastSpell(15, 10, 4, -3876, -4232, 348, -1, -1, -1) -- Sparks
    evt.CastSpell(15, 10, 4, -5032, -4536, 348, -1, -1, -1) -- Sparks
    evt.CastSpell(15, 10, 4, -4836, -4536, 348, -1, -1, -1) -- Sparks
    evt.CastSpell(15, 10, 4, -4460, -4536, 348, -1, -1, -1) -- Sparks
    evt.CastSpell(15, 10, 4, -4072, -4536, 348, -1, -1, -1) -- Sparks
...
RegisterEvent(131, nil, function()
    ...
    evt.SetFacetBit(10, FacetBits.Invisible, 1)
    evt.SetFacetBit(10, FacetBits.Untouchable, 1)
    AddValue(InventoryItem(612), 612) -- Sarcophagus of Korbu
    SetValue(MapVar(11), 1)
    SetQBit(QBit(211)) -- Sarcophagus of Korbu - I lost it
end)

RegisterEvent(501, "Leave the Crypt of Korbu", function()
    evt.MoveToMap(57, 14827, 1949, 1536, 0, 0, 0, 1, "out08.odm") -- Ravage Roaming
end, "Leave the Crypt of Korbu")
