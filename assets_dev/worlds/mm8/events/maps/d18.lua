...
RegisterEvent(11, "Door", function()
    ...
    evt.SummonMonsters(1, 3, 1, 416, 1296, -128, 1, 0) -- encounter slot 1 "Naga" tier C, count 1, pos=(416, 1296, -128), actor group 1, no unique actor name
...
RegisterEvent(13, "Door", function()
    ...
    evt.SummonMonsters(1, 3, 1, 1744, 368, -128, 1, 0) -- encounter slot 1 "Naga" tier C, count 1, pos=(1744, 368, -128), actor group 1, no unique actor name
...
RegisterEvent(14, "Door", function()
    ...
    evt.SummonMonsters(1, 3, 1, 864, -560, -128, 1, 0) -- encounter slot 1 "Naga" tier C, count 1, pos=(864, -560, -128), actor group 1, no unique actor name
...
RegisterEvent(15, "Door", function()
    ...
    evt.SummonMonsters(1, 3, 1, 416, -576, -128, 1, 0) -- encounter slot 1 "Naga" tier C, count 1, pos=(416, -576, -128), actor group 1, no unique actor name
...
RegisterEvent(76, nil, function()
    ...
    evt.CastSpell(6, 10, 4, 1428, -1284, 1208, 1428, -1284, 760) -- Fireball
    evt.CastSpell(6, 10, 4, 1632, -1284, 1208, 1632, -1284, 760) -- Fireball
    evt.CastSpell(6, 10, 4, 1632, -1624, 1208, 1632, -1624, 760) -- Fireball
    evt.CastSpell(6, 10, 4, 1428, -1624, 1208, 1428, -1624, 760) -- Fireball
...
RegisterEvent(501, "Leave the Naga Vault", function()
    evt.MoveToMap(-14220, 2552, 290, 1536, 0, 0, 0, 1, "out05.odm") -- Garrote Gorge
end, "Leave the Naga Vault")
