...
RegisterEvent(1, nil, function()
    evt.SetMonGroupBit(10, MonsterBits.Hostile, 1) -- actor group 10: spawn Wererat Human Form Male A, spawn Wererat Ratman Form Male A
end)
...
RegisterEvent(501, "Leave the Chapel of Eep", function()
    evt.MoveToMap(-19952, 90, 2048, 1536, 0, 0, 0, 1, "out02.odm") -- Ravenshore
end, "Leave the Chapel of Eep")
