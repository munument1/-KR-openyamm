...
SetMapMetadata({
    ...
    [71] = { kind = "open_door", source = "opcode" },
    [72] = { kind = "open_door", source = "opcode" },
    [73] = { kind = "open_door", source = "opcode" },
    [74] = { kind = "open_door", source = "opcode" },
    [75] = { kind = "open_door", source = "opcode" },
    [76] = { kind = "open_door", source = "opcode" },
    [77] = { kind = "open_door", source = "opcode" },
    [78] = { kind = "open_door", source = "opcode" },
    [79] = { kind = "open_door", source = "opcode" },
    [80] = { kind = "open_door", source = "opcode" },
    ...
    [461] = { kind = "generic_event", source = "opcode" },
    [462] = { kind = "generic_event", source = "opcode" },
    [463] = { kind = "generic_event", source = "opcode" },
...
RegisterEvent(451, "Bookshelf", function()
    if not IsAtLeast(MapVar(41), 3) then
        local randomStep = PickRandomOption(451, 2, {3, 5, 7, 9, 11, 14})
        ...
        elseif randomStep == 14 then
            evt.StatusText("You found nothing of interest")
        end
...
RegisterEvent(454, "Bookshelf", function()
    if not IsAtLeast(MapVar(43), 3) then
...
RegisterEvent(456, "Bookshelf", function()
    if not IsAtLeast(MapVar(44), 3) then
        local randomStep = PickRandomOption(456, 2, {3, 5, 7, 9, 11, 14})
        if randomStep == 3 then
            evt.GiveItem(5, ItemType.Scroll_)
        elseif randomStep == 5 then
            evt.GiveItem(5, ItemType.Scroll_)
...
RegisterEvent(457, "Bookshelf", function()
    if not IsAtLeast(MapVar(45), 3) then
        local randomStep = PickRandomOption(457, 2, {3, 5, 7, 9, 11, 14})
        if randomStep == 3 then
            evt.GiveItem(5, ItemType.Scroll_)
        elseif randomStep == 5 then
            evt.GiveItem(5, ItemType.Scroll_)
...
RegisterEvent(458, "Bookshelf", function()
    if not IsAtLeast(MapVar(46), 3) then
        local randomStep = PickRandomOption(458, 2, {3, 5, 7, 9, 11, 14})
        if randomStep == 3 then
            evt.GiveItem(5, ItemType.Scroll_)
        elseif randomStep == 5 then
            evt.GiveItem(5, ItemType.Scroll_)
...
RegisterEvent(459, "Bookshelf", function()
    if not IsAtLeast(MapVar(47), 3) then
        local randomStep = PickRandomOption(459, 2, {3, 5, 7, 9, 11, 14})
        if randomStep == 3 then
            evt.GiveItem(5, ItemType.Scroll_)
        elseif randomStep == 5 then
            evt.GiveItem(5, ItemType.Scroll_)
...
RegisterEvent(460, "Bookshelf", function()
    if not IsAtLeast(MapVar(48), 3) then
        local randomStep = PickRandomOption(460, 2, {3, 5, 7, 9, 11, 14})
        if randomStep == 3 then
            evt.GiveItem(5, ItemType.Scroll_)
        elseif randomStep == 5 then
            evt.GiveItem(5, ItemType.Scroll_)
...
RegisterEvent(461, "Bookshelf", function()
    if not IsAtLeast(MapVar(49), 3) then
        local randomStep = PickRandomOption(461, 2, {3, 5, 7, 9, 11, 14})
        if randomStep == 3 then
            evt.GiveItem(5, ItemType.Scroll_)
        elseif randomStep == 5 then
            evt.GiveItem(5, ItemType.Scroll_)
...
RegisterEvent(462, "Bookshelf", function()
    if not IsAtLeast(MapVar(50), 3) then
        local randomStep = PickRandomOption(462, 2, {3, 5, 7, 9, 11, 14})
        if randomStep == 3 then
            evt.GiveItem(5, ItemType.Scroll_)
        elseif randomStep == 5 then
            evt.GiveItem(5, ItemType.Scroll_)
...
RegisterEvent(463, "Bookshelf", function()
    evt.StatusText("You found nothing of interest")
end, "Bookshelf")

RegisterEvent(501, "Leave the Uplifted Library", function()
    evt.MoveToMap(14848, -19669, 257, 1536, 0, 0, 0, 1, "out01.odm") -- Dagger Wound Island
end, "Leave the Uplifted Library")
