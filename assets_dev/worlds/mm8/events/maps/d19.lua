...
SetMapMetadata({
    ...
    [18] = { kind = "press_button", source = "title" },
    ...
    [201] = { kind = "enter_house", source = "opcode", houseId = 213, targetName = "Sandro/Thant's Throne Room" },
    [203] = { kind = "enter_house", source = "opcode", houseId = 754, targetName = "Dyson Leland's Room" },
    [452] = { kind = "open_door", source = "title" },
    [454] = { kind = "open_door", source = "opcode" },
    [501] = { kind = "leave_dungeon", source = "opcode", targetMap = "out06.odm", targetName = "Shadowspire" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
