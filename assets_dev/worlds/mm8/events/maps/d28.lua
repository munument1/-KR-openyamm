...
RegisterEvent(451, "Tomb of Lord Brinne", function()
    if IsQBitSet(QBit(237)) then return end -- You got a flute
    AddValue(InventoryItem(634), 634) -- Flute
    SetQBit(QBit(237)) -- You got a flute
end, "Tomb of Lord Brinne")

RegisterEvent(501, "Leave the Tomb of Lord Brinne", function()
    evt.MoveToMap(18199, 12520, 1, 1024, 0, 0, 0, 1, "out02.odm") -- Ravenshore
end, "Leave the Tomb of Lord Brinne")
