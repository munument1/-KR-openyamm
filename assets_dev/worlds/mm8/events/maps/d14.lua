...
RegisterEvent(104, nil, function()
    ...
    evt.CastSpell(2, 30, 4, -4004, -5984, -848, -4380, -5984, -848) -- Fire Bolt
end)

RegisterEvent(501, "Leave the Cyclops Larder", function()
    evt.MoveToMap(14045, -18343, 641, 512, 0, 0, 0, 1, "out04.odm") -- Ironsand Desert
end, "Leave the Cyclops Larder")
