...
SetMapMetadata({
    ...
    [131] = { kind = "enter_house", source = "opcode", houseId = 703, targetName = "Brimstone's Cave" },
...
RegisterEvent(131, "Brimstone's Cave", function()
    evt.EnterHouse(703) -- Brimstone's Cave
end, "Brimstone's Cave")

RegisterEvent(501, "Leave Yaardrake's Cave", function()
    evt.MoveToMap(21749, 21967, 2144, 1024, 0, 0, 0, 3, "out06.odm") -- Shadowspire
end, "Leave Yaardrake's Cave")
