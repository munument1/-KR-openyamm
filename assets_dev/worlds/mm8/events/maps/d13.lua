...
SetMapMetadata({
    ...
    [78] = { kind = "open_door", source = "title" },
    ...
    [458] = { kind = "open_door", source = "opcode" },
    ...
    [475] = { kind = "open_door", source = "opcode" },
    [476] = { kind = "open_door", source = "opcode" },
    [477] = { kind = "open_door", source = "opcode" },
    [478] = { kind = "open_door", source = "opcode" },
    [501] = { kind = "leave_dungeon", source = "opcode", targetMap = "out04.odm", targetName = "Ironsand Desert" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
