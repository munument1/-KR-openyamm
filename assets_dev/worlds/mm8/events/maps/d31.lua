...
SetMapMetadata({
    ...
    contextActions = {
    [11] = { kind = "use_elevator", source = "title" },
    [12] = { kind = "use_elevator", source = "title" },
    [13] = { kind = "use_elevator", source = "title" },
    [14] = { kind = "use_elevator", source = "title" },
    ...
    [501] = { kind = "leave_dungeon", source = "opcode", targetMap = "out13.odm", targetName = "Regna" },
    [502] = { kind = "passage", source = "opcode", targetMap = "d33.blv", targetName = "Passage Under Regna" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
...
RegisterEvent(11, "Lift", function()
    evt.SetDoorState(71, DoorAction.Open)
end, "Lift")

RegisterEvent(12, "Lift", function()
    evt.SetDoorState(71, DoorAction.Close)
end, "Lift")

RegisterEvent(13, "Lift", function()
    evt.SetDoorState(72, DoorAction.Open)
end, "Lift")

RegisterEvent(14, "Lift", function()
...
RegisterEvent(501, "Leave the Pirate Stronghold", function()
    evt.MoveToMap(8373, -4645, 1664, 0, 0, 0, 0, 1, "out13.odm") -- Regna
end, "Leave the Pirate Stronghold")

RegisterEvent(502, "Leave the Pirate Stronghold", function()
    evt.MoveToMap(384, -64, 1, 948, 0, 0, 0, 1, "d33.blv") -- Passage Under Regna
end, "Leave the Pirate Stronghold")
