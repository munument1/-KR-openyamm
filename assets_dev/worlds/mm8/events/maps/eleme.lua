...
SetMapMetadata({
    ...
    [201] = { kind = "enter_house", source = "opcode", houseId = 676, targetName = "Loamwalker's House" },
    [203] = { kind = "enter_house", source = "opcode", houseId = 677, targetName = "Soil's House" },
    [205] = { kind = "enter_house", source = "opcode", houseId = 678, targetName = "Empty House" },
    [207] = { kind = "enter_house", source = "opcode", houseId = 679, targetName = "Empty House" },
    [209] = { kind = "enter_house", source = "opcode", houseId = 680, targetName = "Empty House" },
    [211] = { kind = "enter_house", source = "opcode", houseId = 681, targetName = "Empty House" },
    [213] = { kind = "enter_house", source = "opcode", houseId = 682, targetName = "Empty House" },
    [215] = { kind = "enter_house", source = "opcode", houseId = 683, targetName = "Empty House" },
    [217] = { kind = "enter_house", source = "opcode", houseId = 684, targetName = "Empty House" },
    [219] = { kind = "enter_house", source = "opcode", houseId = 685, targetName = "Empty House" },
    [223] = { kind = "enter_house", source = "opcode", houseId = 696, targetName = "Griven's House" },
    [451] = { kind = "generic_event", source = "opcode" },
    [505] = { kind = "leave_dungeon", source = "opcode", targetMap = "out01.odm", targetName = "Dagger Wound Island" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
...
RegisterEvent(6, nil, function()
    ...
    if HasItem(609) then -- Heart of Earth
        SetQBit(QBit(244)) -- Got the heart of earth
        AddValue(Experience, 100000)
        SetQBit(QBit(208)) -- Heart of Earth - I lost it
    end
end)
...
RegisterEvent(451, "Take a Drink", function()
    if not IsAtLeast(EarthResistance, 10) then
        ...
        SetAutonote(228) -- Well in the Plane of Earth gives a permanent Earth Resistance bonus up to an Earth Resistance of 10.
        return
    end
...
RegisterEvent(505, "Leave the Plane of Earth", function()
    evt.MoveToMap(19776, -14112, 867, 512, 0, 0, 0, 1, "out01.odm") -- Dagger Wound Island
