...
SetMapMetadata({
    ...
    [201] = { kind = "enter_house", source = "opcode", houseId = 661, targetName = "Air Lord's Cell" },
...
RegisterEvent(201, "Air Lord's Cell", function()
    evt.EnterHouse(661) -- Air Lord's Cell
end, "Air Lord's Cell")

RegisterEvent(501, "Leave the Prison of the Lord of Air", function()
    evt.MoveToMap(17459, 18470, 1024, 1024, 0, 0, 0, 1, "pbp.odm") -- Plane Between Planes
end, "Leave the Prison of the Lord of Air")
