...
RegisterEvent(5, nil, function()
    evt.SetMonGroupBit(10, MonsterBits.Hostile, 1) -- actor group 10: spawn 0 A, spawn Vampire (monster) A
end)
...
RegisterEvent(501, "Leave the Vampire Crypt", function()
    evt.MoveToMap(11624, 4562, 1280, 1152, 0, 0, 0, 1, "out06.odm") -- Shadowspire
end, "Leave the Vampire Crypt")
