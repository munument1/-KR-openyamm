...
RegisterEvent(501, "Leave the Grand Temple of Eep", function()
    evt.MoveToMap(20791, 12317, 2560, 1024, 0, 0, 0, 1, "out05.odm") -- Garrote Gorge
end, "Leave the Grand Temple of Eep")
