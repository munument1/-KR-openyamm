...
SetMapMetadata({
    ...
    contextActions = {
    [11] = { kind = "enter_house", source = "opcode", houseId = 509, targetName = "Withersmythe Estate" },
    [13] = { kind = "enter_house", source = "opcode", houseId = 510, targetName = "Vespers Hall" },
    [15] = { kind = "enter_house", source = "opcode", houseId = 511, targetName = "Hall of Solis" },
    [17] = { kind = "enter_house", source = "opcode", houseId = 512, targetName = "Eversmyle Hall" },
    [19] = { kind = "enter_house", source = "opcode", houseId = 513, targetName = "Moore Cottage" },
    [21] = { kind = "enter_house", source = "opcode", houseId = 514, targetName = "House of Krewlen" },
    [23] = { kind = "enter_house", source = "opcode", houseId = 515, targetName = "Darkenmoore Hall" },
    [25] = { kind = "enter_house", source = "opcode", houseId = 516, targetName = "Dervish Estate" },
    [27] = { kind = "enter_house", source = "opcode", houseId = 517, targetName = "Agraynel Hall" },
    [29] = { kind = "enter_house", source = "opcode", houseId = 518, targetName = "House of Lightfinger" },
    [31] = { kind = "enter_house", source = "opcode", houseId = 519, targetName = "Nightwalker Cottage" },
    [33] = { kind = "enter_house", source = "opcode", houseId = 520, targetName = "Sparkman Home" },
    [35] = { kind = "enter_house", source = "opcode", houseId = 521, targetName = "Sablewood Hall" },
    [37] = { kind = "enter_house", source = "opcode", houseId = 522, targetName = "Steele Estate" },
    [39] = { kind = "enter_house", source = "opcode", houseId = 523, targetName = "Guild of Bounty Hunters" },
    [41] = { kind = "enter_house", source = "opcode", houseId = 524, targetName = "Watershed Cottage" },
    [43] = { kind = "enter_house", source = "opcode", houseId = 525, targetName = "Fromago Manor" },
    [45] = { kind = "enter_house", source = "opcode", houseId = 526, targetName = "Blackthorne Estate" },
    [47] = { kind = "enter_house", source = "opcode", houseId = 527, targetName = "House of Nevermore" },
    [49] = { kind = "enter_house", source = "opcode", houseId = 528, targetName = "Ittalle Cottage" },
    [51] = { kind = "enter_house", source = "opcode", houseId = 529, targetName = "Havest Hall" },
    [53] = { kind = "enter_house", source = "opcode", houseId = 530, targetName = "Iverson Estate" },
    [55] = { kind = "enter_house", source = "opcode", houseId = 531, targetName = "Oscleton Residence" },
    [57] = { kind = "enter_house", source = "opcode", houseId = 532, targetName = "Thelbourne Residence" },
    [59] = { kind = "enter_house", source = "opcode", houseId = 533, targetName = "Greydawn Residence" },
    [61] = { kind = "enter_house", source = "opcode", houseId = 534, targetName = "House Stellare" },
    [63] = { kind = "enter_house", source = "opcode", houseId = 535, targetName = "House of Brandy" },
    [65] = { kind = "enter_house", source = "opcode", houseId = 536, targetName = "Bowes Residence" },
    [67] = { kind = "enter_house", source = "opcode", houseId = 537, targetName = "Breman Residence" },
    [69] = { kind = "enter_house", source = "opcode", houseId = 547, targetName = " Home of Rihansi " },
    [71] = { kind = "enter_house", source = "opcode", houseId = 548, targetName = "Bombah Hall" },
    [73] = { kind = "enter_house", source = "opcode", houseId = 549, targetName = "Keldon's Cottage" },
    [75] = { kind = "enter_house", source = "opcode", houseId = 552, targetName = "Featherwind's House" },
    [77] = { kind = "enter_house", source = "opcode", houseId = 551, targetName = "House Farswell" },
    [79] = { kind = "enter_house", source = "opcode", houseId = 550, targetName = "Veldon's Cottage" },
    ...
    [171] = { kind = "enter_house", source = "opcode", houseId = 3, targetName = "Polished Steel" },
    [173] = { kind = "enter_house", source = "opcode", houseId = 38, targetName = "Armory" },
    [175] = { kind = "enter_house", source = "opcode", houseId = 78, targetName = "Arcane Items" },
    [177] = { kind = "enter_house", source = "opcode", houseId = 112, targetName = "Prepared Potions" },
    [179] = { kind = "enter_house", source = "opcode", houseId = 187, targetName = "Self Study" },
    [181] = { kind = "enter_house", source = "opcode", houseId = 453, targetName = "Guild Caravans" },
    [185] = { kind = "enter_house", source = "opcode", houseId = 305, targetName = "House of Healing" },
    [187] = { kind = "enter_house", source = "opcode", houseId = 1566, targetName = "Guild Training Hall" },
    [189] = { kind = "enter_house", source = "opcode", houseId = 763, targetName = "Placeholder" },
    [191] = { kind = "enter_house", source = "opcode", houseId = 230, targetName = "Profit House" },
    [193] = { kind = "enter_house", source = "opcode", houseId = 283, targetName = "Guild House of Finance" },
    [195] = { kind = "enter_house", source = "opcode", houseId = 238, targetName = "Miho's Roadhouse" },
    [197] = { kind = "enter_house", source = "opcode", houseId = 773, targetName = "Merchant Guildhouse" },
    [199] = { kind = "enter_house", source = "opcode", houseId = 183, targetName = "Elemental Guild" },
    ...
    [491] = { kind = "teleport", source = "heuristic" },
    [501] = { kind = "enter_dungeon", source = "opcode", targetMap = "d11.blv", targetName = "Wasp Nest" },
    [502] = { kind = "enter_dungeon", source = "opcode", targetMap = "d12.blv", targetName = "Ogre Fortress" },
    [503] = { kind = "enter_dungeon", source = "opcode", targetMap = "d41.blv", targetName = "Dark Dwarf Compound" },
    [504] = { kind = "enter_dungeon", source = "opcode", targetMap = "d11.blv", targetName = "Wasp Nest" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
    timers = {
    { eventId = 131, sourceEventId = 131, triggerStep = 0, origin = "legacy", triggerKind = "timer", scheduleKind = "interval", intervalHalfMinutes = 20 },
    { eventId = 479, sourceEventId = 479, triggerStep = 0, origin = "legacy", triggerKind = "timer", scheduleKind = "interval", intervalHalfMinutes = 25 },
