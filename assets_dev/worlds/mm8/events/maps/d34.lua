...
SetMapMetadata({
    ...
    [451] = { kind = "passage", source = "opcode", targetMap = "d06.blv", targetName = "Pirate Outpost" },
...
RegisterEvent(1, nil, function()
    if IsQBitSet(QBit(223)) then return end -- Took Sub to Regna
    SetQBit(QBit(223)) -- Took Sub to Regna
end)
...
RegisterEvent(451, "Enter the Submarine", function()
    ...
    evt.MoveToMap(7097, -1117, -639, 1536, 0, 0, 0, 1, "d06.blv") -- Pirate Outpost
end, "Enter the Submarine")

RegisterEvent(501, "Leave the Small Sub Pen", function()
    evt.MoveToMap(7425, -2538, 829, 512, 0, 0, 0, 1, "out13.odm") -- Regna
end, "Leave the Small Sub Pen")
