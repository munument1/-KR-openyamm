...
RegisterEvent(10, "Legacy event 10", function(continueStep)
    ...
    evt.SetMessage("\"A voice whispers -I am the spirit of the swamp, congratulations, take what you may and leave in peace-\"")
    evt._PressAnyKey(10, 3)
end)
