...
SetMapMetadata({
    ...
    contextActions = {
    [2] = { kind = "enter_house", source = "opcode", houseId = 24, targetName = "Fine Blades" },
    [4] = { kind = "enter_house", source = "opcode", houseId = 64, targetName = "Metalweave Armory" },
    [6] = { kind = "enter_house", source = "opcode", houseId = 101, targetName = "Eye of Newt" },
    [8] = { kind = "enter_house", source = "opcode", houseId = 471, targetName = "Royal Lines " },
    [10] = { kind = "enter_house", source = "opcode", houseId = 1589, targetName = "Royal Gymnasium" },
    [12] = { kind = "enter_house", source = "opcode", houseId = 264, targetName = "The King's Crown" },
    [14] = { kind = "enter_house", source = "opcode", houseId = 132, targetName = "Initiate Guild of Fire" },
    [16] = { kind = "enter_house", source = "opcode", houseId = 336, targetName = "Castle Newton" },
    [18] = { kind = "enter_house", source = "opcode", houseId = 450, targetName = "The Seer" },
    [19] = { kind = "enter_house", source = "opcode", houseId = 332, targetName = "King's Temple" },
    [40] = { kind = "generic_event", source = "opcode" },
    [41] = { kind = "generic_event", source = "opcode" },
    [42] = { kind = "enter_house", source = "opcode", houseId = 1215, targetName = "King's Library" },
    [43] = { kind = "enter_house", source = "opcode", houseId = 222, targetName = "Throne Room" },
    [44] = { kind = "enter_house", source = "opcode", houseId = 497, targetName = "Zephyr" },
    [45] = { kind = "enter_house", source = "opcode", houseId = 498, targetName = "Queen Catherine" },
    [46] = { kind = "enter_house", source = "opcode", houseId = 25, targetName = "The Eagle's Eye" },
    [48] = { kind = "enter_house", source = "opcode", houseId = 68, targetName = "Iron Defense" },
    [50] = { kind = "enter_house", source = "opcode", houseId = 265, targetName = "The Will o' Wisp" },
    [52] = { kind = "enter_house", source = "opcode", houseId = 156, targetName = "Initiate Guild of Spirit" },
    [54] = { kind = "enter_house", source = "opcode", houseId = 162, targetName = "Initiate Guild of Mind" },
    [56] = { kind = "enter_house", source = "opcode", houseId = 168, targetName = "Initiate Guild of Body" },
    [58] = { kind = "enter_house", source = "opcode", houseId = 1225, targetName = "House" },
    [59] = { kind = "enter_house", source = "opcode", houseId = 1240, targetName = "House" },
    [60] = { kind = "enter_house", source = "opcode", houseId = 1255, targetName = "House" },
    [61] = { kind = "enter_house", source = "opcode", houseId = 1285, targetName = "House" },
    [62] = { kind = "enter_house", source = "opcode", houseId = 1300, targetName = "House" },
    [63] = { kind = "enter_house", source = "opcode", houseId = 1313, targetName = "House" },
    [64] = { kind = "enter_house", source = "opcode", houseId = 1325, targetName = "House" },
    [65] = { kind = "enter_house", source = "opcode", houseId = 1359, targetName = "House" },
    [66] = { kind = "enter_house", source = "opcode", houseId = 1371, targetName = "House" },
    [67] = { kind = "enter_house", source = "opcode", houseId = 1382, targetName = "House" },
    [68] = { kind = "enter_house", source = "opcode", houseId = 1393, targetName = "House" },
    [69] = { kind = "enter_house", source = "opcode", houseId = 1412, targetName = "House" },
    [70] = { kind = "enter_house", source = "opcode", houseId = 1421, targetName = "House" },
    [71] = { kind = "enter_house", source = "opcode", houseId = 1270, targetName = "House" },
    [72] = { kind = "enter_house", source = "opcode", houseId = 1348, targetName = "House" },
    [73] = { kind = "enter_house", source = "opcode", houseId = 1403, targetName = "House" },
    [74] = { kind = "enter_house", source = "opcode", houseId = 1429, targetName = "House" },
    [75] = { kind = "enter_house", source = "opcode", houseId = 1438, targetName = "House" },
    ...
    [81] = { kind = "open_chest", source = "opcode", chestIds = {1} },
    [82] = { kind = "enter_house", source = "opcode", houseId = 202, targetName = "Berserkers' Fury" },
    [83] = { kind = "enter_house", source = "opcode", houseId = 1387, targetName = "House" },
    [90] = { kind = "enter_house", source = "opcode", houseId = 425, targetName = "Shadow Guild Hideout" },
    [91] = { kind = "enter_house", source = "opcode", houseId = 430, targetName = "Snergle's Caverns" },
    [92] = { kind = "enter_house", source = "opcode", houseId = 432, targetName = "Dragoons' Caverns" },
    [93] = { kind = "enter_house", source = "opcode", houseId = 440, targetName = "Corlagon's Estate" },
    [94] = { kind = "enter_house", source = "opcode", houseId = 418, targetName = "Temple of Baa" },
    [97] = { kind = "enter_house", source = "opcode", houseId = 334, targetName = "Temple Baa" },
    [100] = { kind = "fountain", source = "title" },
    [101] = { kind = "fountain", source = "title" },
    [102] = { kind = "fountain", source = "title" },
    [201] = { kind = "teleport", source = "heuristic" },
    [203] = { kind = "teleport", source = "heuristic" },
    [210] = { kind = "teleport", source = "heuristic" },
    [225] = { kind = "secret_event", source = "heuristic", hidden = true },
    [231] = { kind = "well", source = "title" },
    [232] = { kind = "obelisk", source = "title" },
