...
SetMapMetadata({
    ...
    [13] = { kind = "open_chest", source = "opcode", chestIds = {0} },
    [14] = { kind = "open_chest", source = "opcode", chestIds = {1} },
...
RegisterEvent(50, "Exit", function()
    evt.MoveToMap(-17658, -12361, 257, 1024, 0, 0, 0, 0, "outd1.odm") -- Silver Cove
end, "Exit")
