...
SetMapMetadata({
    ...
    contextActions = {
    [3] = { kind = "enter_house", source = "opcode", houseId = 51, targetName = "Buckskins and Bucklers" },
    [5] = { kind = "enter_house", source = "opcode", houseId = 87, targetName = "Natural Magic" },
    [7] = { kind = "enter_house", source = "opcode", houseId = 119, targetName = "The Bubbling Cauldron" },
    [9] = { kind = "enter_house", source = "opcode", houseId = 463, targetName = "Hu's Stallions" },
    [11] = { kind = "enter_house", source = "opcode", houseId = 487, targetName = "Sea Sprite" },
    [13] = { kind = "enter_house", source = "opcode", houseId = 313, targetName = "Nature's Remedies" },
    [15] = { kind = "enter_house", source = "opcode", houseId = 1573, targetName = "The Proving Grounds" },
    [17] = { kind = "enter_house", source = "opcode", houseId = 205, targetName = "Pierpont Townhall" },
    [19] = { kind = "enter_house", source = "opcode", houseId = 242, targetName = "Emerald Inn" },
    [21] = { kind = "enter_house", source = "opcode", houseId = 288, targetName = "Nature's Stockpile" },
    [23] = { kind = "enter_house", source = "opcode", houseId = 130, targetName = "Master Guild of Fire" },
    [25] = { kind = "enter_house", source = "opcode", houseId = 136, targetName = "Master Guild of Air" },
    [27] = { kind = "enter_house", source = "opcode", houseId = 141, targetName = "Adept Guild of Water" },
    [29] = { kind = "enter_house", source = "opcode", houseId = 147, targetName = "Adept Guild of Earth" },
    [32] = { kind = "enter_house", source = "opcode", houseId = 11, targetName = "Hunter's Lodge" },
    [52] = { kind = "enter_house", source = "opcode", houseId = 946, targetName = "Bith Residence" },
    [53] = { kind = "enter_house", source = "opcode", houseId = 947, targetName = "Suretrail Home" },
    [54] = { kind = "enter_house", source = "opcode", houseId = 948, targetName = "Silverpoint Residence" },
    [55] = { kind = "enter_house", source = "opcode", houseId = 949, targetName = "Miyon's Home" },
    [56] = { kind = "enter_house", source = "opcode", houseId = 950, targetName = "Green House" },
    [57] = { kind = "enter_house", source = "opcode", houseId = 951, targetName = "Warlin Residence" },
    [58] = { kind = "enter_house", source = "opcode", houseId = 952, targetName = "Dotes Residence" },
    [59] = { kind = "enter_house", source = "opcode", houseId = 953, targetName = "Blueswan Home" },
    [60] = { kind = "enter_house", source = "opcode", houseId = 954, targetName = "Treasurestone Home" },
    [61] = { kind = "enter_house", source = "opcode", houseId = 955, targetName = "Windsong House" },
    [62] = { kind = "enter_house", source = "opcode", houseId = 956, targetName = "Whitecap Residence" },
    [63] = { kind = "enter_house", source = "opcode", houseId = 957, targetName = "Ottin House" },
    [64] = { kind = "enter_house", source = "opcode", houseId = 958, targetName = "Black House" },
    [65] = { kind = "enter_house", source = "opcode", houseId = 959, targetName = "Fiddlebone Residence" },
    [66] = { kind = "enter_house", source = "opcode", houseId = 960, targetName = "Kerrid Residence" },
    [67] = { kind = "enter_house", source = "opcode", houseId = 961, targetName = "Willowbark's Home" },
    [68] = { kind = "enter_house", source = "opcode", houseId = 962, targetName = "House 324" },
    [69] = { kind = "enter_house", source = "opcode", houseId = 963, targetName = "House 325" },
    [70] = { kind = "enter_house", source = "opcode", houseId = 964, targetName = "House 326" },
    [71] = { kind = "enter_house", source = "opcode", houseId = 965, targetName = "Benjamin's Home" },
    [72] = { kind = "enter_house", source = "opcode", houseId = 966, targetName = "Stonewright Residence" },
    [73] = { kind = "enter_house", source = "opcode", houseId = 967, targetName = "Weatherson's House" },
    [74] = { kind = "enter_house", source = "opcode", houseId = 968, targetName = "Sower Residence" },
    ...
    [204] = { kind = "fountain", source = "title" },
    ...
    [259] = { kind = "generic_event", source = "opcode" },
    [260] = { kind = "generic_event", source = "opcode" },
    [261] = { kind = "generic_event", source = "opcode" },
    [452] = { kind = "shrine", source = "title" },
    [453] = { kind = "obelisk", source = "title" },
    [501] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d32.blv", targetName = "Castle Navan" },
    [502] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d08.blv", targetName = "The Tularean Caves" },
    [503] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d12.blv", targetName = "Clanker's Laboratory" },
    },
    textureNames = {},
