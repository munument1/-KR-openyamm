...
SetMapMetadata({
    ...
    [501] = { kind = "passage", source = "opcode", targetMap = "mdr04.blv", targetName = "Barrow XI" },
    [502] = { kind = "passage", source = "opcode", targetMap = "mdt05.blv", targetName = "Barrow XIII" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
...
RegisterEvent(501, "Leave the Dwarven Barrow", function()
    if not IsAtLeast(MapVar(3), 2) then
        evt.MoveToMap(2826, 2025, -15, 896, 0, 0, 0, 0, "mdr04.blv") -- Barrow XI
        return
    end
    evt.MoveToMap(406, 365, 49, 640, 0, 0, 0, 0, "mdt03.blv") -- Barrow I
