...
SetMapMetadata({
    ...
    contextActions = {
    [2] = { kind = "enter_house", source = "opcode", houseId = 8, targetName = "The Knight's Blade" },
    [4] = { kind = "enter_house", source = "opcode", houseId = 43, targetName = "Erik's Armory" },
    [6] = { kind = "enter_house", source = "opcode", houseId = 84, targetName = "Emerald Enchantments" },
    [8] = { kind = "enter_house", source = "opcode", houseId = 116, targetName = "The Blue Bottle" },
    [10] = { kind = "enter_house", source = "opcode", houseId = 310, targetName = "Healer's Tent" },
    [12] = { kind = "enter_house", source = "opcode", houseId = 1570, targetName = "Island Training Grounds" },
    [14] = { kind = "enter_house", source = "opcode", houseId = 239, targetName = "Two Palms Tavern" },
    [16] = { kind = "enter_house", source = "opcode", houseId = 128, targetName = "Initiate Guild of Fire" },
    [18] = { kind = "enter_house", source = "opcode", houseId = 134, targetName = "Initiate Guild of Air" },
    [20] = { kind = "enter_house", source = "opcode", houseId = 152, targetName = "Initiate Guild of Spirit" },
    [22] = { kind = "enter_house", source = "opcode", houseId = 164, targetName = "Initiate Guild of Body" },
    [24] = { kind = "enter_house", source = "opcode", houseId = 1168, targetName = "The Lady Margaret" },
    [50] = { kind = "enter_house", source = "opcode", houseId = 1167, targetName = "Donna Wyrith's Residence" },
    [51] = { kind = "enter_house", source = "opcode", houseId = 1170, targetName = "Mia Lucille' Home" },
    [52] = { kind = "enter_house", source = "opcode", houseId = 1171, targetName = "Vandalir Residence" },
    [53] = { kind = "enter_house", source = "opcode", houseId = 1172, targetName = "House 227" },
    [54] = { kind = "enter_house", source = "opcode", houseId = 1173, targetName = "House 228" },
    [55] = { kind = "enter_house", source = "opcode", houseId = 1174, targetName = "House 229" },
    [56] = { kind = "enter_house", source = "opcode", houseId = 1183, targetName = "Carolyn Weathers' House" },
    [57] = { kind = "enter_house", source = "opcode", houseId = 1184, targetName = "Tellmar Residence" },
    [58] = { kind = "enter_house", source = "opcode", houseId = 1185, targetName = "House 241" },
    [59] = { kind = "enter_house", source = "opcode", houseId = 1186, targetName = "House 242" },
    [60] = { kind = "enter_house", source = "opcode", houseId = 1198, targetName = "House 254" },
    [61] = { kind = "enter_house", source = "opcode", houseId = 1199, targetName = "House 255" },
    [62] = { kind = "enter_house", source = "opcode", houseId = 1199, targetName = "House 255" },
    [66] = { kind = "enter_house", source = "opcode", houseId = 1163, targetName = "Markham's Headquarters" },
    [101] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d06.blv", targetName = "The Temple of the Moon" },
    [102] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d28.blv", targetName = "The Dragon's Lair" },
    [110] = { kind = "well", source = "title" },
    [112] = { kind = "well", source = "title" },
    [113] = { kind = "well", source = "title" },
    [114] = { kind = "well", source = "title" },
    [115] = { kind = "well", source = "title" },
    [118] = { kind = "open_chest", source = "opcode", chestIds = {1} },
    [119] = { kind = "open_chest", source = "opcode", chestIds = {2} },
    [120] = { kind = "open_chest", source = "opcode", chestIds = {3} },
    [121] = { kind = "open_chest", source = "opcode", chestIds = {4} },
    [122] = { kind = "open_chest", source = "opcode", chestIds = {5} },
    [123] = { kind = "open_chest", source = "opcode", chestIds = {6} },
    [124] = { kind = "open_chest", source = "opcode", chestIds = {7} },
    [219] = { kind = "press_button", source = "title" },
