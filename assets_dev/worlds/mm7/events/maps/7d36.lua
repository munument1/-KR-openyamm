...
SetMapMetadata({
    ...
    [501] = { kind = "leave_dungeon", source = "opcode", targetMap = "out12.odm", targetName = "The Land of the Giants" },
    [502] = { kind = "passage", source = "opcode", targetMap = "7d07.blv", targetName = "Thunderfist Mountain" },
    },
    textureNames = {"cwb1"},
    spriteNames = {},
    castSpellIds = {},
