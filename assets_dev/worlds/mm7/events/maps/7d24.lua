...
SetMapMetadata({
    ...
    [151] = { kind = "press_button", source = "title" },
    [152] = { kind = "press_button", source = "title" },
    [153] = { kind = "press_button", source = "title" },
    [154] = { kind = "press_button", source = "title" },
    [176] = { kind = "open_chest", source = "opcode", chestIds = {0} },
    [177] = { kind = "open_chest", source = "opcode", chestIds = {1} },
    [178] = { kind = "open_chest", source = "opcode", chestIds = {2} },
    [179] = { kind = "open_chest", source = "opcode", chestIds = {3} },
    [180] = { kind = "open_chest", source = "opcode", chestIds = {4} },
    [181] = { kind = "open_chest", source = "opcode", chestIds = {5} },
    [182] = { kind = "open_chest", source = "opcode", chestIds = {6} },
    [183] = { kind = "open_chest", source = "opcode", chestIds = {7} },
    [184] = { kind = "open_chest", source = "opcode", chestIds = {8} },
    [185] = { kind = "open_chest", source = "opcode", chestIds = {9} },
    [186] = { kind = "open_chest", source = "opcode", chestIds = {10} },
    [187] = { kind = "open_chest", source = "opcode", chestIds = {11} },
    [188] = { kind = "open_chest", source = "opcode", chestIds = {12} },
    [189] = { kind = "open_chest", source = "opcode", chestIds = {13} },
    [190] = { kind = "open_chest", source = "opcode", chestIds = {14} },
    [191] = { kind = "open_chest", source = "opcode", chestIds = {15} },
    [192] = { kind = "open_chest", source = "opcode", chestIds = {16} },
    [193] = { kind = "open_chest", source = "opcode", chestIds = {17} },
    [194] = { kind = "open_chest", source = "opcode", chestIds = {18} },
    [195] = { kind = "open_chest", source = "opcode", chestIds = {19} },
    ...
    [201] = { kind = "generic_event", source = "opcode" },
    [415] = { kind = "obelisk", source = "title" },
    [416] = { kind = "enter_house", source = "opcode", houseId = 216, targetName = "Throne Room" },
    [417] = { kind = "enter_house", source = "opcode", houseId = 17, targetName = "The Balanced Axe" },
    [419] = { kind = "enter_house", source = "opcode", houseId = 57, targetName = "The Polished Pauldron" },
    [421] = { kind = "enter_house", source = "opcode", houseId = 93, targetName = "Delicate Things" },
    [423] = { kind = "enter_house", source = "opcode", houseId = 124, targetName = "Potent Potions & Brews" },
    [425] = { kind = "enter_house", source = "opcode", houseId = 321, targetName = "Temple of Stone" },
    [427] = { kind = "enter_house", source = "opcode", houseId = 1579, targetName = "War College" },
    [429] = { kind = "enter_house", source = "opcode", houseId = 252, targetName = "Grogg's Grog" },
    [431] = { kind = "enter_house", source = "opcode", houseId = 293, targetName = "Mineral Wealth" },
    [433] = { kind = "enter_house", source = "opcode", houseId = 148, targetName = "Master Guild of Earth" },
    [435] = { kind = "enter_house", source = "opcode", houseId = 1051, targetName = "Keenedge Residence" },
    [436] = { kind = "enter_house", source = "opcode", houseId = 1052, targetName = "Seline's House" },
    [437] = { kind = "enter_house", source = "opcode", houseId = 1053, targetName = "Welman Residence" },
    [438] = { kind = "enter_house", source = "opcode", houseId = 1054, targetName = "Thain's House" },
    [439] = { kind = "enter_house", source = "opcode", houseId = 1055, targetName = "Gizmo's" },
    [440] = { kind = "enter_house", source = "opcode", houseId = 1056, targetName = "Spark's House" },
    [441] = { kind = "enter_house", source = "opcode", houseId = 1057, targetName = "Thorinson Residence" },
    [442] = { kind = "enter_house", source = "opcode", houseId = 1058, targetName = "Urthsmite Residence" },
    [443] = { kind = "enter_house", source = "opcode", houseId = 216, targetName = "Throne Room" },
    [501] = { kind = "leave_dungeon", source = "opcode", targetMap = "out11.odm", targetName = "The Barrow Downs" },
    [502] = { kind = "passage", source = "opcode", targetMap = "7d35.blv", targetName = "Nighon Tunnels" },
    },
    textureNames = {"cwb1"},
    spriteNames = {},
    castSpellIds = {},
