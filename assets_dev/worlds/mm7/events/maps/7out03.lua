...
SetMapMetadata({
    ...
    contextActions = {
    [3] = { kind = "enter_house", source = "opcode", houseId = 49, targetName = "Queen Catherine's Smithy" },
    [5] = { kind = "enter_house", source = "opcode", houseId = 86, targetName = "Her Majesty's Magics" },
    [7] = { kind = "enter_house", source = "opcode", houseId = 118, targetName = "Lead Transformations" },
    [9] = { kind = "enter_house", source = "opcode", houseId = 462, targetName = "Royal Steeds" },
    [11] = { kind = "enter_house", source = "opcode", houseId = 486, targetName = "Lady Catherine" },
    [13] = { kind = "enter_house", source = "opcode", houseId = 312, targetName = "House of Solace" },
    [15] = { kind = "enter_house", source = "opcode", houseId = 1572, targetName = "In Her Majesty's Service" },
    [17] = { kind = "enter_house", source = "opcode", houseId = 204, targetName = "Steadwick Townhall" },
    [19] = { kind = "enter_house", source = "opcode", houseId = 241, targetName = "Griffin's Rest" },
    [21] = { kind = "enter_house", source = "opcode", houseId = 287, targetName = "Bank of Erathia" },
    [23] = { kind = "enter_house", source = "opcode", houseId = 155, targetName = "Paramount Guild of Spirit" },
    [25] = { kind = "enter_house", source = "opcode", houseId = 159, targetName = "Adept Guild of Mind" },
    [27] = { kind = "enter_house", source = "opcode", houseId = 166, targetName = "Master Guild of Body" },
    [29] = { kind = "enter_house", source = "opcode", houseId = 10, targetName = "The Queen's Forge" },
    [52] = { kind = "enter_house", source = "opcode", houseId = 910, targetName = "Guthwulf's Home" },
    [53] = { kind = "enter_house", source = "opcode", houseId = 911, targetName = "Wolverton Residence" },
    [54] = { kind = "enter_house", source = "opcode", houseId = 912, targetName = "House 271" },
    [55] = { kind = "enter_house", source = "opcode", houseId = 913, targetName = "House 272" },
    [56] = { kind = "enter_house", source = "opcode", houseId = 914, targetName = "House 273" },
    [57] = { kind = "enter_house", source = "opcode", houseId = 915, targetName = "Castro's House" },
    [59] = { kind = "enter_house", source = "opcode", houseId = 916, targetName = "Laraselle Residence" },
    [60] = { kind = "enter_house", source = "opcode", houseId = 917, targetName = "Sourbrow Home" },
    [62] = { kind = "enter_house", source = "opcode", houseId = 919, targetName = "Agraynel Residence" },
    [65] = { kind = "enter_house", source = "opcode", houseId = 920, targetName = "House 282" },
    [66] = { kind = "enter_house", source = "opcode", houseId = 921, targetName = "Tish Residence" },
    [67] = { kind = "enter_house", source = "opcode", houseId = 922, targetName = "Talion House" },
    [68] = { kind = "enter_house", source = "opcode", houseId = 923, targetName = "Ravenhill Residence" },
    [69] = { kind = "enter_house", source = "opcode", houseId = 924, targetName = "Cardrin Residence" },
    [71] = { kind = "enter_house", source = "opcode", houseId = 926, targetName = "Gareth's Home" },
    [72] = { kind = "enter_house", source = "opcode", houseId = 927, targetName = "Forgewright Residence" },
    [73] = { kind = "enter_house", source = "opcode", houseId = 928, targetName = "Pretty House" },
    [74] = { kind = "enter_house", source = "opcode", houseId = 929, targetName = "Lotts Familly Home" },
    [76] = { kind = "enter_house", source = "opcode", houseId = 931, targetName = "Julian's Home" },
    [77] = { kind = "enter_house", source = "opcode", houseId = 932, targetName = "Eversmyle Residence" },
    [78] = { kind = "enter_house", source = "opcode", houseId = 933, targetName = "Dirthmoore Residence" },
    [81] = { kind = "enter_house", source = "opcode", houseId = 936, targetName = "Heartsworn Home" },
    [82] = { kind = "enter_house", source = "opcode", houseId = 937, targetName = "Cardron Residence" },
    [84] = { kind = "enter_house", source = "opcode", houseId = 939, targetName = "Thrush Residence" },
    [85] = { kind = "enter_house", source = "opcode", houseId = 940, targetName = "Hillier Residence" },
    [86] = { kind = "enter_house", source = "opcode", houseId = 941, targetName = "Quixote Residence" },
    [87] = { kind = "enter_house", source = "opcode", houseId = 942, targetName = "Org House" },
    [88] = { kind = "enter_house", source = "opcode", houseId = 943, targetName = "Talreish Residence" },
    [89] = { kind = "enter_house", source = "opcode", houseId = 944, targetName = "Barnes Home" },
    [90] = { kind = "enter_house", source = "opcode", houseId = 945, targetName = "Havest Residence" },
    [93] = { kind = "enter_house", source = "opcode", houseId = 1128, targetName = "Ravenswood Residence" },
    [94] = { kind = "enter_house", source = "opcode", houseId = 1129, targetName = "Blayze's" },
    [95] = { kind = "enter_house", source = "opcode", houseId = 1130, targetName = "Norris' House" },
    ...
    [169] = { kind = "open_chest", source = "opcode", chestIds = {18, 19} },
    [170] = { kind = "open_chest", source = "opcode", chestIds = {0} },
    [202] = { kind = "well", source = "title" },
    [203] = { kind = "well", source = "title" },
    [204] = { kind = "well", source = "title" },
    [205] = { kind = "well", source = "title" },
    [208] = { kind = "fountain", source = "title" },
    [209] = { kind = "well", source = "title" },
    [210] = { kind = "fountain", source = "title" },
    [251] = { kind = "generic_event", source = "opcode" },
    [252] = { kind = "generic_event", source = "opcode" },
    [253] = { kind = "generic_event", source = "opcode" },
    [254] = { kind = "generic_event", source = "opcode" },
    [255] = { kind = "generic_event", source = "opcode" },
    [256] = { kind = "generic_event", source = "opcode" },
    [257] = { kind = "generic_event", source = "opcode" },
    [258] = { kind = "generic_event", source = "opcode" },
    [402] = { kind = "press_button", source = "title" },
    [403] = { kind = "press_button", source = "title" },
    [404] = { kind = "press_button", source = "title" },
    [405] = { kind = "press_button", source = "title" },
    [406] = { kind = "press_button", source = "title" },
    [452] = { kind = "shrine", source = "title" },
    [453] = { kind = "obelisk", source = "title" },
    [495] = { kind = "enter_house", source = "opcode", houseId = 1131, targetName = "Dreamwright Residence" },
    [496] = { kind = "enter_house", source = "opcode", houseId = 1132, targetName = "Wain Manor" },
    [501] = { kind = "enter_dungeon", source = "opcode", targetMap = "d01.blv", targetName = "The Erathian Sewers" },
    [502] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d31.blv", targetName = "Fort Riverstride" },
    [503] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d33.blv", targetName = "Castle Gryphonheart" },
    [504] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d33.blv", targetName = "Castle Gryphonheart" },
    [505] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d31.blv", targetName = "Fort Riverstride" },
    [506] = { kind = "enter_dungeon", source = "opcode", targetMap = "d01.blv", targetName = "The Erathian Sewers" },
    [507] = { kind = "enter_dungeon", source = "opcode", targetMap = "d01.blv", targetName = "The Erathian Sewers" },
    [508] = { kind = "enter_dungeon", source = "opcode", targetMap = "mdt11.blv", targetName = "The Hidden Tomb" },
    [509] = { kind = "enter_dungeon", source = "opcode", targetMap = "mdt14.blv", targetName = "The Bandit Caves" },
    },
    textureNames = {},
