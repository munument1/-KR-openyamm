...
SetMapMetadata({
    ...
    contextActions = {
    [3] = { kind = "enter_house", source = "opcode", houseId = 55, targetName = "The Missing Link" },
    [5] = { kind = "enter_house", source = "opcode", houseId = 466, targetName = "Dry Saddles" },
    [7] = { kind = "enter_house", source = "opcode", houseId = 491, targetName = "Narwhale" },
    [9] = { kind = "enter_house", source = "opcode", houseId = 319, targetName = "The Order of Tatalia" },
    [11] = { kind = "enter_house", source = "opcode", houseId = 1577, targetName = "Training Essentials" },
    [13] = { kind = "enter_house", source = "opcode", houseId = 250, targetName = "The Loyal Mercenary" },
    [15] = { kind = "enter_house", source = "opcode", houseId = 291, targetName = "The Depository" },
    [17] = { kind = "enter_house", source = "opcode", houseId = 160, targetName = "Master Guild of Mind" },
    [19] = { kind = "enter_house", source = "opcode", houseId = 15, targetName = "Vander's Blades & Bows" },
    [21] = { kind = "enter_house", source = "opcode", houseId = 19, targetName = "Alloyed Weapons" },
    [23] = { kind = "enter_house", source = "opcode", houseId = 59, targetName = "Alloyed Armor and Shields" },
    [52] = { kind = "enter_house", source = "opcode", houseId = 1025, targetName = "Steele Residence" },
    [53] = { kind = "enter_house", source = "opcode", houseId = 1026, targetName = "Conscience Home" },
    [54] = { kind = "enter_house", source = "opcode", houseId = 1027, targetName = "Everil's House" },
    [57] = { kind = "enter_house", source = "opcode", houseId = 1030, targetName = "Tricia's House" },
    [58] = { kind = "enter_house", source = "opcode", houseId = 1031, targetName = "Isram's House" },
    [59] = { kind = "enter_house", source = "opcode", houseId = 1032, targetName = "Stonecleaver Residence" },
    [61] = { kind = "enter_house", source = "opcode", houseId = 1034, targetName = "Calindra's Home" },
    [62] = { kind = "enter_house", source = "opcode", houseId = 1035, targetName = "Brother Bombah's" },
    [63] = { kind = "enter_house", source = "opcode", houseId = 1036, targetName = "Redding Residence" },
    [65] = { kind = "enter_house", source = "opcode", houseId = 1038, targetName = "Fist's House" },
    [66] = { kind = "enter_house", source = "opcode", houseId = 1039, targetName = "Wacko's" },
    [67] = { kind = "enter_house", source = "opcode", houseId = 1040, targetName = "Weldric's Home" },
    [69] = { kind = "enter_house", source = "opcode", houseId = 1042, targetName = "Visconti Residence" },
    [70] = { kind = "enter_house", source = "opcode", houseId = 1043, targetName = "Arin Residence" },
    [73] = { kind = "enter_house", source = "opcode", houseId = 1046, targetName = "Sampson Residence" },
    [75] = { kind = "enter_house", source = "opcode", houseId = 1048, targetName = "Taren's House" },
    [76] = { kind = "enter_house", source = "opcode", houseId = 1049, targetName = "Moore Residence" },
    [77] = { kind = "enter_house", source = "opcode", houseId = 1050, targetName = "Rothham's House" },
    [78] = { kind = "enter_house", source = "opcode", houseId = 1005, targetName = "Greydawn Residence" },
    [79] = { kind = "enter_house", source = "opcode", houseId = 1006, targetName = "Stormeye's House" },
    [80] = { kind = "enter_house", source = "opcode", houseId = 1007, targetName = "Bremen Residence" },
    [81] = { kind = "enter_house", source = "opcode", houseId = 989, targetName = "Riverstone House" },
    ...
    [214] = { kind = "generic_event", source = "opcode" },
    [401] = { kind = "shrine", source = "title" },
    [452] = { kind = "shrine", source = "title" },
    [453] = { kind = "obelisk", source = "title" },
    [501] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d16.blv", targetName = "The Wine Cellar" },
    [502] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d20.blv", targetName = "The Mercenary Guild" },
    [503] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d17.blv", targetName = "The Tidewater Caverns" },
    [504] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d18.blv", targetName = "Lord Markham's Manor" },
    [505] = { kind = "enter_dungeon", source = "opcode", targetMap = "mdt09.blv", targetName = "Wromthrax's Cave" },
    },
    textureNames = {},
    spriteNames = {"0"},
    castSpellIds = {},
