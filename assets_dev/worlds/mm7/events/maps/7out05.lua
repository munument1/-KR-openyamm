...
SetMapMetadata({
    ...
    contextActions = {
    [3] = { kind = "enter_house", source = "opcode", houseId = 120, targetName = "The Blackened Vial" },
    [5] = { kind = "enter_house", source = "opcode", houseId = 464, targetName = "Faithful Steeds" },
    [7] = { kind = "enter_house", source = "opcode", houseId = 314, targetName = "Temple of Dark" },
    [9] = { kind = "enter_house", source = "opcode", houseId = 243, targetName = "The Snobbish Goblin" },
    [11] = { kind = "enter_house", source = "opcode", houseId = 154, targetName = "Master Guild of Spirit" },
    [13] = { kind = "enter_house", source = "opcode", houseId = 176, targetName = "Guild of Twilight" },
    [15] = { kind = "enter_house", source = "opcode", houseId = 88, targetName = "Death's Door" },
    [52] = { kind = "enter_house", source = "opcode", houseId = 969, targetName = "Karrand Residence" },
    [53] = { kind = "enter_house", source = "opcode", houseId = 970, targetName = "Cleareye's Home" },
    [54] = { kind = "enter_house", source = "opcode", houseId = 971, targetName = "Foestryke Residence" },
    [55] = { kind = "enter_house", source = "opcode", houseId = 972, targetName = "Oxhide Residence" },
    [56] = { kind = "enter_house", source = "opcode", houseId = 973, targetName = "Shadowrunner's Home" },
    [57] = { kind = "enter_house", source = "opcode", houseId = 974, targetName = "Kedrin Residence" },
    [58] = { kind = "enter_house", source = "opcode", houseId = 975, targetName = "Botham's Home" },
    [59] = { kind = "enter_house", source = "opcode", houseId = 976, targetName = "Mogren Residence" },
    [60] = { kind = "enter_house", source = "opcode", houseId = 977, targetName = "Draken Residence" },
    [61] = { kind = "enter_house", source = "opcode", houseId = 978, targetName = "Harli's Place" },
    [62] = { kind = "enter_house", source = "opcode", houseId = 979, targetName = "Nevermore Residence" },
    [63] = { kind = "enter_house", source = "opcode", houseId = 980, targetName = "Wiseman Residence" },
    [64] = { kind = "enter_house", source = "opcode", houseId = 981, targetName = "Nightcrawler Residence" },
    [65] = { kind = "enter_house", source = "opcode", houseId = 982, targetName = "Felburn's House" },
    [66] = { kind = "enter_house", source = "opcode", houseId = 983, targetName = "Undershadow's Home" },
    [67] = { kind = "enter_house", source = "opcode", houseId = 984, targetName = "Slicer's House" },
    [68] = { kind = "enter_house", source = "opcode", houseId = 985, targetName = "Falk Residence" },
    [69] = { kind = "enter_house", source = "opcode", houseId = 1133, targetName = "Putnam Residence" },
    [70] = { kind = "enter_house", source = "opcode", houseId = 1134, targetName = "Hawker Residence" },
    [71] = { kind = "enter_house", source = "opcode", houseId = 1135, targetName = "Avalanche's" },
    ...
    [206] = { kind = "well", source = "title" },
    [207] = { kind = "well", source = "title" },
    ...
    [501] = { kind = "enter_dungeon", source = "opcode", targetMap = "t04.blv", targetName = "The Hall of the Pit" },
    [502] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d15.blv", targetName = "Watchtower 6" },
    [503] = { kind = "enter_dungeon", source = "opcode", targetMap = "mdt10.blv", targetName = "William Setag's Tower" },
    [504] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d15.blv", targetName = "Watchtower 6" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
