...
SetMapMetadata({
    ...
    contextActions = {
    [99] = { kind = "enter_house", source = "opcode", houseId = 488, targetName = "Enchantress" },
    [101] = { kind = "enter_house", source = "opcode", houseId = 89, targetName = "Artifacts & Antiquities" },
    [103] = { kind = "enter_house", source = "opcode", houseId = 121, targetName = "Edmond's Ampules" },
    [105] = { kind = "enter_house", source = "opcode", houseId = 465, targetName = "Crystal Caravans" },
    [107] = { kind = "enter_house", source = "opcode", houseId = 315, targetName = "Temple of Light" },
    [109] = { kind = "enter_house", source = "opcode", houseId = 244, targetName = "Familiar Place" },
    [111] = { kind = "enter_house", source = "opcode", houseId = 142, targetName = "Master Guild of Water" },
    [113] = { kind = "enter_house", source = "opcode", houseId = 171, targetName = "Guild of Illumination" },
    [151] = { kind = "enter_house", source = "opcode", houseId = 1110, targetName = "Smiling Jack's" },
    [152] = { kind = "enter_house", source = "opcode", houseId = 1111, targetName = "Pederton Residence" },
    [153] = { kind = "enter_house", source = "opcode", houseId = 1112, targetName = "Applebee Manor" },
    [154] = { kind = "enter_house", source = "opcode", houseId = 1113, targetName = "Lightsworn Residence" },
    [155] = { kind = "enter_house", source = "opcode", houseId = 1114, targetName = "Alashandra's Home" },
    [156] = { kind = "enter_house", source = "opcode", houseId = 1115, targetName = "Gayle's" },
    [157] = { kind = "enter_house", source = "opcode", houseId = 1116, targetName = "Brigham's Home" },
    [158] = { kind = "enter_house", source = "opcode", houseId = 1117, targetName = "Rowan's House" },
    [159] = { kind = "enter_house", source = "opcode", houseId = 1118, targetName = "Brand's Home" },
    [160] = { kind = "enter_house", source = "opcode", houseId = 1119, targetName = "Benson Residence" },
    [161] = { kind = "enter_house", source = "opcode", houseId = 1120, targetName = "Zimm's House" },
    [162] = { kind = "enter_house", source = "opcode", houseId = 1136, targetName = "Stone House" },
    [163] = { kind = "enter_house", source = "opcode", houseId = 1137, targetName = "Watershed Residence" },
    [164] = { kind = "enter_house", source = "opcode", houseId = 1138, targetName = "Hollyfield Residence" },
    [165] = { kind = "enter_house", source = "opcode", houseId = 1139, targetName = "Sweet Residence" },
    [201] = { kind = "open_chest", source = "opcode", chestIds = {1} },
    [202] = { kind = "open_chest", source = "opcode", chestIds = {2} },
    [203] = { kind = "open_chest", source = "opcode", chestIds = {3} },
    [204] = { kind = "open_chest", source = "opcode", chestIds = {4} },
    [205] = { kind = "open_chest", source = "opcode", chestIds = {5} },
    [206] = { kind = "open_chest", source = "opcode", chestIds = {6} },
    [207] = { kind = "open_chest", source = "opcode", chestIds = {7} },
    [208] = { kind = "open_chest", source = "opcode", chestIds = {8} },
    [209] = { kind = "open_chest", source = "opcode", chestIds = {9} },
    [210] = { kind = "open_chest", source = "opcode", chestIds = {10} },
    [211] = { kind = "open_chest", source = "opcode", chestIds = {11} },
    [212] = { kind = "open_chest", source = "opcode", chestIds = {12} },
    [213] = { kind = "open_chest", source = "opcode", chestIds = {13} },
    [214] = { kind = "open_chest", source = "opcode", chestIds = {14} },
    [215] = { kind = "open_chest", source = "opcode", chestIds = {15} },
    [216] = { kind = "open_chest", source = "opcode", chestIds = {16} },
    [217] = { kind = "open_chest", source = "opcode", chestIds = {17} },
    [218] = { kind = "open_chest", source = "opcode", chestIds = {18} },
    [219] = { kind = "open_chest", source = "opcode", chestIds = {19} },
    [220] = { kind = "open_chest", source = "opcode", chestIds = {0} },
    [301] = { kind = "teleport", source = "heuristic" },
    [302] = { kind = "teleport", source = "heuristic" },
    [303] = { kind = "teleport", source = "heuristic" },
    [304] = { kind = "teleport", source = "heuristic" },
    [305] = { kind = "teleport", source = "heuristic" },
    [306] = { kind = "teleport", source = "heuristic" },
    [307] = { kind = "teleport", source = "heuristic" },
    [308] = { kind = "teleport", source = "heuristic" },
    [309] = { kind = "teleport", source = "heuristic" },
    [310] = { kind = "teleport", source = "heuristic" },
    [311] = { kind = "teleport", source = "heuristic" },
    [312] = { kind = "teleport", source = "heuristic" },
    [313] = { kind = "teleport", source = "heuristic" },
    [314] = { kind = "teleport", source = "heuristic" },
    [315] = { kind = "teleport", source = "heuristic" },
    [316] = { kind = "teleport", source = "heuristic" },
    [317] = { kind = "teleport", source = "heuristic" },
    [452] = { kind = "shrine", source = "title" },
    [453] = { kind = "obelisk", source = "title" },
    [457] = { kind = "well", source = "title" },
    [458] = { kind = "well", source = "title" },
    [459] = { kind = "well", source = "title" },
    [460] = { kind = "generic_event", source = "opcode" },
    [461] = { kind = "fountain", source = "title" },
    [501] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d14.blv", targetName = "The School of Sorcery" },
    [502] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d34.blv", targetName = "The Red Dwarf Mines" },
    [503] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d25.blv", targetName = "Celeste" },
    },
    textureNames = {},
    spriteNames = {"0"},
    castSpellIds = {},
