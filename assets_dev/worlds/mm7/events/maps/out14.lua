...
SetMapMetadata({
    ...
    contextActions = {
    [3] = { kind = "enter_house", source = "opcode", houseId = 56, targetName = "Avlee Outpost" },
    [5] = { kind = "enter_house", source = "opcode", houseId = 467, targetName = "Plush Coaches" },
    [7] = { kind = "enter_house", source = "opcode", houseId = 492, targetName = "Wind Runner" },
    [9] = { kind = "enter_house", source = "opcode", houseId = 320, targetName = "Temple of Tranquility" },
    [11] = { kind = "enter_house", source = "opcode", houseId = 1578, targetName = "Avlee Gymnaisium" },
    [13] = { kind = "enter_house", source = "opcode", houseId = 251, targetName = "The Potted Pixie" },
    [15] = { kind = "enter_house", source = "opcode", houseId = 292, targetName = "Halls of Gold" },
    [17] = { kind = "enter_house", source = "opcode", houseId = 161, targetName = "Paramount Guild of Mind" },
    [19] = { kind = "enter_house", source = "opcode", houseId = 167, targetName = "Paramount Guild of Body" },
    [21] = { kind = "enter_house", source = "opcode", houseId = 16, targetName = "The Knocked Bow" },
    [52] = { kind = "enter_house", source = "opcode", houseId = 1014, targetName = "Featherwind Residence" },
    [53] = { kind = "enter_house", source = "opcode", houseId = 1015, targetName = "Ravenhair Residence" },
    [54] = { kind = "enter_house", source = "opcode", houseId = 1020, targetName = "Snick House" },
    [55] = { kind = "enter_house", source = "opcode", houseId = 1021, targetName = "Infernon's House" },
    [56] = { kind = "enter_house", source = "opcode", houseId = 1022, targetName = "Deerhunter Residence" },
    [57] = { kind = "enter_house", source = "opcode", houseId = 1023, targetName = "Swiftfoot's House" },
    [58] = { kind = "enter_house", source = "opcode", houseId = 1140, targetName = "Tempus' House" },
    [59] = { kind = "enter_house", source = "opcode", houseId = 1141, targetName = "Kaine's" },
    [60] = { kind = "enter_house", source = "opcode", houseId = 1142, targetName = "Apple Residence" },
    [63] = { kind = "enter_house", source = "opcode", houseId = 1016, targetName = "Jillian's House" },
    [64] = { kind = "enter_house", source = "opcode", houseId = 1017, targetName = "Greenstorm Residence" },
    [67] = { kind = "enter_house", source = "opcode", houseId = 1008, targetName = "Brightspear Residence" },
    [68] = { kind = "enter_house", source = "opcode", houseId = 1009, targetName = "Holden Residence" },
    ...
    [501] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d09.blv", targetName = "The Titans' Stronghold" },
    [502] = { kind = "enter_dungeon", source = "opcode", targetMap = "d04.blv", targetName = "The Temple of Baa" },
    [503] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d22.blv", targetName = "The Hall under the Hill" },
    },
    textureNames = {},
