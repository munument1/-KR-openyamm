...
SetMapMetadata({
    ...
    contextActions = {
    [3] = { kind = "enter_house", source = "opcode", houseId = 9, targetName = "Tempered Steel" },
    [5] = { kind = "enter_house", source = "opcode", houseId = 47, targetName = "The Peasant's Smithy" },
    [7] = { kind = "enter_house", source = "opcode", houseId = 85, targetName = "Otto's Oddities" },
    [9] = { kind = "enter_house", source = "opcode", houseId = 117, targetName = "Philters and Elixirs" },
    [11] = { kind = "enter_house", source = "opcode", houseId = 311, targetName = "WelNin Cathedral" },
    [13] = { kind = "enter_house", source = "opcode", houseId = 1571, targetName = "Basic Principles" },
    [15] = { kind = "enter_house", source = "opcode", houseId = 240, targetName = "On the House" },
    [17] = { kind = "enter_house", source = "opcode", houseId = 129, targetName = "Adept Guild of Fire" },
    [19] = { kind = "enter_house", source = "opcode", houseId = 135, targetName = "Adept Guild of Air" },
    [21] = { kind = "enter_house", source = "opcode", houseId = 153, targetName = "Adept Guild of Spirit" },
    [23] = { kind = "enter_house", source = "opcode", houseId = 165, targetName = "Adept Guild of Body" },
    [25] = { kind = "enter_house", source = "opcode", houseId = 140, targetName = "Initiate Guild of Water" },
    [27] = { kind = "enter_house", source = "opcode", houseId = 146, targetName = "Initiate Guild of Earth" },
    [29] = { kind = "enter_house", source = "opcode", houseId = 158, targetName = "Initiate Guild of Mind" },
    [31] = { kind = "enter_house", source = "opcode", houseId = 286, targetName = "The Vault" },
    [33] = { kind = "enter_house", source = "opcode", houseId = 203, targetName = "Harmondale Townhall" },
    [35] = { kind = "enter_house", source = "opcode", houseId = 461, targetName = "The J.V.C Corral" },
    [37] = { kind = "enter_house", source = "opcode", houseId = 1165, targetName = "Arbiter" },
    [112] = { kind = "open_chest", source = "opcode", chestIds = {1} },
    [113] = { kind = "open_chest", source = "opcode", chestIds = {2} },
    [114] = { kind = "open_chest", source = "opcode", chestIds = {3} },
    [115] = { kind = "open_chest", source = "opcode", chestIds = {4} },
    [116] = { kind = "open_chest", source = "opcode", chestIds = {5} },
    [117] = { kind = "open_chest", source = "opcode", chestIds = {6} },
    [118] = { kind = "open_chest", source = "opcode", chestIds = {7} },
    [119] = { kind = "open_chest", source = "opcode", chestIds = {8} },
    [120] = { kind = "open_chest", source = "opcode", chestIds = {9} },
    [121] = { kind = "open_chest", source = "opcode", chestIds = {10} },
    [122] = { kind = "open_chest", source = "opcode", chestIds = {11} },
    [123] = { kind = "open_chest", source = "opcode", chestIds = {12} },
    [150] = { kind = "generic_event", source = "opcode" },
    [151] = { kind = "generic_event", source = "opcode" },
    [152] = { kind = "generic_event", source = "opcode" },
    [153] = { kind = "generic_event", source = "opcode" },
    [154] = { kind = "generic_event", source = "opcode" },
    [155] = { kind = "generic_event", source = "opcode" },
    [156] = { kind = "generic_event", source = "opcode" },
    [157] = { kind = "generic_event", source = "opcode" },
    [218] = { kind = "well", source = "title" },
    [220] = { kind = "obelisk", source = "title" },
    [221] = { kind = "travel", source = "opcode", targetMap = "out12.odm", targetName = "The Land of the Giants" },
    [223] = { kind = "well", source = "title" },
    [227] = { kind = "fountain", source = "title" },
    [228] = { kind = "well", source = "title" },
    [236] = { kind = "secret_event", source = "heuristic", hidden = true },
    [251] = { kind = "enter_house", source = "opcode", houseId = 1101, targetName = "Mist Manor" },
    [252] = { kind = "enter_house", source = "opcode", houseId = 1102, targetName = "Hillsmen Residence" },
    [253] = { kind = "enter_house", source = "opcode", houseId = 1103, targetName = "Stillwater Residence" },
    [254] = { kind = "enter_house", source = "opcode", houseId = 1104, targetName = "Mark Manor" },
    [255] = { kind = "enter_house", source = "opcode", houseId = 1105, targetName = "Bowes Residence" },
    [256] = { kind = "enter_house", source = "opcode", houseId = 1106, targetName = "Temper Residence" },
    [257] = { kind = "enter_house", source = "opcode", houseId = 1107, targetName = "Krewlen Residence" },
    [258] = { kind = "enter_house", source = "opcode", houseId = 1108, targetName = "Withersmythe's Home" },
    [260] = { kind = "enter_house", source = "opcode", houseId = 1121, targetName = "Kern Residence" },
    [261] = { kind = "enter_house", source = "opcode", houseId = 1122, targetName = "Chadric's House" },
    [262] = { kind = "enter_house", source = "opcode", houseId = 1123, targetName = "Weider Residence" },
    [263] = { kind = "enter_house", source = "opcode", houseId = 1126, targetName = "Hume Residence" },
    [264] = { kind = "enter_house", source = "opcode", houseId = 1127, targetName = "Farswell Residence" },
    [267] = { kind = "enter_house", source = "opcode", houseId = 1124, targetName = "Skinner's House" },
    [268] = { kind = "enter_house", source = "opcode", houseId = 1125, targetName = "Torrent's" },
    [301] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d29.blv", targetName = "Castle Harmondale" },
    [302] = { kind = "enter_dungeon", source = "opcode", targetMap = "7d21.blv", targetName = "White Cliff Cave" },
    },
