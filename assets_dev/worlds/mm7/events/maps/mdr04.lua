...
SetMapMetadata({
    ...
    [501] = { kind = "passage", source = "opcode", targetMap = "mdt03.blv", targetName = "Barrow I" },
    [502] = { kind = "passage", source = "opcode", targetMap = "mdk03.blv", targetName = "Barrow II" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
...
RegisterEvent(1, nil, function()
    if not IsQBitSet(QBit(705)) then -- Turn on map in mdrXX(Dwarven Barrow)
        evt.SetMonGroupBit(56, MonsterBits.Hostile, 1) -- actor group 56: spawn Bat A, spawn Zombie A
        return
    end
...
RegisterEvent(501, "Leave the Dwarven Barrow", function()
    ...
    evt.MoveToMap(414, 278, -31, 1408, 0, 0, 0, 0, "mdt02.blv") -- Barrow VI
...
RegisterEvent(502, "Leave the Dwarven Barrow", function()
    ...
    evt.MoveToMap(-346, 265, 33, 1792, 0, 0, 0, 0, "mdt05.blv") -- Barrow XIII
end, "Leave the Dwarven Barrow")
