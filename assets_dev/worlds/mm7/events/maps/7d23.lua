...
SetMapMetadata({
    ...
    [47] = { kind = "open_door", source = "opcode" },
    [49] = { kind = "open_door", source = "opcode" },
    [50] = { kind = "open_door", source = "opcode" },
    [51] = { kind = "open_door", source = "opcode" },
    [52] = { kind = "open_door", source = "opcode" },
    [53] = { kind = "open_door", source = "opcode" },
    [54] = { kind = "open_door", source = "opcode" },
    [55] = { kind = "open_door", source = "opcode" },
    [56] = { kind = "open_door", source = "opcode" },
    [151] = { kind = "open_door", source = "opcode" },
    [152] = { kind = "open_door", source = "opcode" },
    [153] = { kind = "open_door", source = "opcode" },
    [154] = { kind = "open_door", source = "opcode" },
    [155] = { kind = "open_door", source = "opcode" },
    [156] = { kind = "open_door", source = "opcode" },
    [157] = { kind = "open_door", source = "opcode" },
    [158] = { kind = "open_door", source = "opcode" },
    [159] = { kind = "open_door", source = "opcode" },
    ...
    [459] = { kind = "open_door", source = "opcode" },
    [460] = { kind = "open_door", source = "opcode" },
    [461] = { kind = "open_door", source = "opcode" },
    [462] = { kind = "open_door", source = "opcode" },
    [463] = { kind = "open_door", source = "opcode" },
    [464] = { kind = "open_door", source = "opcode" },
    [465] = { kind = "open_door", source = "opcode" },
    ...
    [470] = { kind = "open_door", source = "opcode" },
    [471] = { kind = "open_door", source = "opcode" },
    [472] = { kind = "open_door", source = "opcode" },
    [473] = { kind = "open_door", source = "opcode" },
    [474] = { kind = "open_door", source = "opcode" },
    [475] = { kind = "generic_event", source = "opcode" },
    [501] = { kind = "leave_dungeon", source = "opcode", targetMap = "7out15.odm", targetName = "Shoals" },
    },
    textureNames = {"sfpnlon"},
    spriteNames = {},
    castSpellIds = {15},
    timers = {
    { eventId = 476, sourceEventId = 476, triggerStep = 0, origin = "legacy", triggerKind = "timer", scheduleKind = "interval", intervalHalfMinutes = 4 },
    { eventId = 477, sourceEventId = 477, triggerStep = 0, origin = "legacy", triggerKind = "timer", scheduleKind = "interval", intervalHalfMinutes = 2 },
    },
})
