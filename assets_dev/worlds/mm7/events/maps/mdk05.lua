...
SetMapMetadata({
    ...
    [501] = { kind = "passage", source = "opcode", targetMap = "mdr01.blv", targetName = "Barrow X" },
    [502] = { kind = "passage", source = "opcode", targetMap = "mdr02.blv", targetName = "Barrow XII" },
    },
    textureNames = {},
    spriteNames = {},
    castSpellIds = {},
...
RegisterEvent(1, nil, function()
    if not IsQBitSet(QBit(704)) then -- Turn on map in mdkXX(Dwarven Barrow)
        evt.SetMonGroupBit(56, MonsterBits.Hostile, 1) -- actor group 56: spawn Ghoul A, spawn Rat A
        return
    end
...
RegisterEvent(502, "Leave the Dwarven Barrow", function()
    ...
    evt.MoveToMap(-365, 231, 1, 1792, 0, 0, 0, 0, "mdt04.blv") -- Barrow VIII
end, "Leave the Dwarven Barrow")
