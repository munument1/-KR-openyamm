...
{
    static const auto PortraitNames = std::to_array<std::pair<std::string_view, PortraitId>>({
        ...
        {"Portrait46", PortraitId::Scared},
        {"Scared", PortraitId::Scared},
        {"Portrait47", PortraitId::Portrait47},
        {"Portrait48", PortraitId::Portrait48},
        {"Portrait49", PortraitId::Portrait49},
        {"Portrait50", PortraitId::Portrait50},
        {"Portrait51", PortraitId::Portrait51},
        {"Portrait52", PortraitId::Portrait52},
        {"Portrait53", PortraitId::Portrait53},
        {"Portrait54", PortraitId::Portrait54},
        {"Portrait55", PortraitId::Portrait55},
        {"Portrait56", PortraitId::Portrait56},
        {"Portrait57", PortraitId::Portrait57},
...
std::optional<FaceAnimationId> faceAnimationIdFromName(std::string_view name)
{
    static const auto FaceAnimationNames = std::to_array<std::pair<std::string_view, FaceAnimationId>>({
        ...
        {"TrapExploaded", FaceAnimationId::TrapExploded},
        ...
        {"InventoryFull", FaceAnimationId::CantCarry},
        ...
        {"Deseased", FaceAnimationId::Diseased},
        ...
        {"Unconsious", FaceAnimationId::Unconscious},
        ...
        {"DinkPotion", FaceAnimationId::DrinkPotion},
        {"ReadScroll", FaceAnimationId::ReadScroll},
        {"ReadScoll", FaceAnimationId::ReadScroll},
        ...
        {"SPDrained", FaceAnimationId::SpellPointsDrained},
        ...
        {"Beg", FaceAnimationId::Beg},
        {"BegFail", FaceAnimationId::BegFail},
        {"Threat", FaceAnimationId::Threat},
        {"ThreatFail", FaceAnimationId::ThreatFail},
        {"Bribe", FaceAnimationId::Bribe},
        {"BribeFail", FaceAnimationId::BribeFail},
        {"NPCDontTalk", FaceAnimationId::NpcDontTalk},
        {"NpcDontTalk", FaceAnimationId::NpcDontTalk},
        {"FoundItem", FaceAnimationId::FoundItem},
        {"HireNPC", FaceAnimationId::HireNpc},
        {"HireNpc", FaceAnimationId::HireNpc},
        {"LookUp", FaceAnimationId::LookUp},
        {"LookDown", FaceAnimationId::LookDown},
        {"Yell", FaceAnimationId::Yell},
        {"Falling", FaceAnimationId::Falling},
        {"TavernPacksFull", FaceAnimationId::TavernPacksFull},
        {"ShakeHeadNo", FaceAnimationId::TavernPacksFull},
        {"TavernDrink", FaceAnimationId::TavernDrink},
        {"TavernGotDrunk", FaceAnimationId::TavernGotDrunk},
        {"TavernTip", FaceAnimationId::TavernTip},
        {"TravelHorse", FaceAnimationId::TravelHorse},
        {"ShakeHeadYes", FaceAnimationId::TravelHorse},
        {"TravelBoat", FaceAnimationId::TravelBoat},
        {"ShopIdentify", FaceAnimationId::ShopIdentify},
        {"ShopRepair", FaceAnimationId::ShopRepair},
        {"ShopItemBought", FaceAnimationId::ShopItemBought},
        {"ShopAlreadyIdentified", FaceAnimationId::ShopAlreadyIdentified},
        {"AlreadyIdentified", FaceAnimationId::ShopAlreadyIdentified},
        {"ItemSold", FaceAnimationId::ShopItemSold},
        {"ShopItemSold", FaceAnimationId::ShopItemSold},
        {"SkillLearned", FaceAnimationId::SkillLearned},
        {"ShopWrongShop", FaceAnimationId::ShopWrongShop},
        {"WrongShop", FaceAnimationId::ShopWrongShop},
        {"ShopRude", FaceAnimationId::ShopRude},
        {"BankDeposit", FaceAnimationId::BankDeposit},
        {"TempleHeal", FaceAnimationId::TempleHeal},
        {"SmileBig", FaceAnimationId::TempleHeal},
        {"TempleDonate", FaceAnimationId::TempleDonate},
        {"HelloHouse", FaceAnimationId::HelloHouse},
        {"SkillMasteryIncreased", FaceAnimationId::SkillMasteryIncreased},
        {"SkillMasteryIcreased", FaceAnimationId::SkillMasteryIncreased},
        {"JoinedGuild", FaceAnimationId::JoinedGuild},
        {"LevelUp", FaceAnimationId::LevelUp},
        {"StatBonusIncreased", FaceAnimationId::StatBonusIncreased},
        {"StatBaseIncreased", FaceAnimationId::StatBaseIncreased},
        {"QuestGot", FaceAnimationId::QuestGot},
        {"AwardGot", FaceAnimationId::AwardGot},
        {"AfraidSilent", FaceAnimationId::AfraidSilent},
        {"CheatedDeath", FaceAnimationId::CheatedDeath},
        {"InPrison", FaceAnimationId::InPrison},
        {"ChooseMe", FaceAnimationId::ChooseMe},
        {"Awaken", FaceAnimationId::Awaken},
        {"IdMonsterWeak", FaceAnimationId::IdentifyMonsterWeak},
        {"IdentifyMonsterWeak", FaceAnimationId::IdentifyMonsterWeak},
        {"IdMonsterBig", FaceAnimationId::IdentifyMonsterBig},
        {"IdentifyMonsterBig", FaceAnimationId::IdentifyMonsterBig},
        {"IdMonsterFail", FaceAnimationId::IdentifyMonsterFail},
        {"IdentifyMonsterFail", FaceAnimationId::IdentifyMonsterFail},
        {"LastManStanding", FaceAnimationId::LastManStanding},
        {"NotEnoughFood", FaceAnimationId::NotEnoughFood},
        {"Hungry", FaceAnimationId::NotEnoughFood},
        {"DeathBlow", FaceAnimationId::DeathBlow},
    });
